...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert Fort Erie SEO services, including lead generation, development, and online marketing in Fort Erie, Canada.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Fort Erie SEO | Best SEO Agency in Fort Erie, ON</title>
        <meta
          name="description"
