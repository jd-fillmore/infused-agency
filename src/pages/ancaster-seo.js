...
const SEO = () => {
  return (
    <>
      <Helmet>
        <title>
          Ancaster SEO | Affordable Local Search Engine Optimization
        </title>
        <meta
          name="description"
              ...
              <Row>
                <Col lg="6">
                  <p>
                    ...
                    <Link href="/digital-marketing-Ancaster">
                      digital marketing
                    </Link>
                    , search engine optimization (SEO) ,{" "}
                    <Link href="/wordpress-developer-Ancaster">
                      WordPress development
                    </Link>{" "}
                    and{" "}
                    <Link href="/ecommerce-web-design-Ancaster">
