...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert SEO services, including lead generation, search engine optimization, and online marketing in Ancaster, Canada.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
          ...
          <Container>
            <Row className="web pd-btm-80">
              ...
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Ancaster SEO services</strong> that our{" "}
                  <strong>Ancaster SEO company</strong> provides are pretty
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Our Nearby Ancaster SEO Clients <span>Get Results</span>
                  </h2>
                </Col>
              </Row>
              <Row>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      By using their SEO services, my Ancaster company went from
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with top Ancaster SEO services?
                  </h3>
            ...
            <Container>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    Infused Agency's SEO company in Ancaster conducts specific
                ...
                <Col lg="4">
                  <h5>Link Building</h5>
                  <p>
                    Off of your website, our Ancaster SEO exports utilize
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Ancaster SEO services are conducted by a highly trained
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    ...
                    user experience. This is why our Ancaster SEO agency looks
                ...
                <Col lg="4">
                  <h5>Local SEO</h5>
                  <p>
                    For a more local approach, our Ancaster SEO specialists can
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website, our Ancaster SEO experts are here to help. We'll
          ...
          <section className="seo-why pd-top-80">
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Ancaster</span> SEO
                    Agency
                  </h2>
              ...
              <Row>
                <Col lg="6">
                  <p>
                    Since 2013 we've been able to help countless local Ancaster
            ...
            <Row className="pd-top-80 pd-btm-60">
              <Col lg="12">
                ...
                <p>
                  ...
                  absolutely you need a Ancaster SEO company to help you with
                  SEO services. It's important that our Ancaster SEO experts
                ...
                <p>
                  If you need our Ancaster SEO company to help your company rise
