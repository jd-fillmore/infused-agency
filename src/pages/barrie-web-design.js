...
const WebDesign = () => {
  return (
    <>
      <Head>
        <title>Barrie Web Design 🥇 Best Web Design Company in Barrie, ON | Infused Agency</title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href="https://infused.agency/barrie-web-design"
        />
        <script
        ...
        <section className="web-design">
          <Container>
            ...
            <Row className="pd-top-80 pd-btm-80">
              ...
              <Col lg="6">
                <p>
                  At Infused Agency, our Barrie web design services are
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6" className="order-1 order-lg-2">
                ...
                <p>
                  ...
                  services. From initial concept to final launch, our Barrie
                  ...
                  Barrie web design solutions, and watch your online presence
                  flourish.
                </p>
                <a
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6">
                ...
                <p>
                  ...
                  calls-to-action, our Barrie web design experts create
              ...
              <Col lg="4" className="d-flex">
                <div className="card">
                  ...
                  <p>
                    ...
                    design services in Barrie. Our websites are crafted to
