...
const WebDesign = () => {
  return (
    <>
      <Head>
        <title>Waterloo Web Design 🥇 Best Web Design Company in Waterloo, ON | Infused Agency</title>
        <meta
          name="description"
          ...
          <Container>
            ...
            <Row className="pd-top-80 pd-btm-80">
              ...
              <Col lg="6">
                <p>
                  ...
                  Waterloo market. Choose Infused Agency for cutting-edge web
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6" className="order-1 order-lg-2">
                ...
                <p>
                  ...
                  Waterloo-based website is not only visually appealing but also
                  ...
                  Waterloo web design solutions, and watch your online presence
                  flourish.
                </p>
                <a
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6">
                ...
                <p>
                  Ready to transform your Waterloo web design into a
                  conversion powerhouse? Our Conversion-Driven Web Design is
                  expertly crafted to do just that. At Infused Agency, we
                  develop stunning Waterloo web design solutions that not only
