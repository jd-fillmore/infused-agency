...
import intro from "../img/guelph-web-design.webp";
...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert web design services, including lead generation, development, and online marketing in Guelph, Canada.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const WebDesign = () => {
  return (
    <>
      <Head>
        <title>Guelph Web Design | Transforming Ideas into Websites</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Web Design Guelph | Infused Agency"
        />
        <meta
          name="twitter:title"
          content="Web Design Guelph | Infused Agency"
        />
        <link rel="canonical" href="https://infused.agency/guelph-web-design" />
        <script
        ...
        <section className="web-design">
          <Container>
            ...
            <Row>
              <Col md="6">
                <h2>
                  Guelph website design crafted to <span>engage</span>,{" "}
            ...
            <Row className="pd-top-80 pd-btm-80">
              <Col lg="6">
                <Image
                  className="img-fluid"
                  src={intro}
                  alt="web design Guelph conversion"
                />
              </Col>
              <Col lg="6">
                <p>
                  At Infused Agency, our Guelph web design services are designed
                  ...
                  Guelph-based businesses. Our team of expert web designers is
                  ...
                  competitive Guelph market. Choose Infused Agency for
            ...
            <div className="niche-services pd-top-40">
              <Row className="text-center w-80">
                <Col lg="12">
                  <h2>
                    Our Guelph Web Design Company Will
                    <br />
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6" className="order-1 order-lg-2">
                ...
                <p>
                  ...
                  in Guelph through our outstanding lead-generation web design
                  services. From initial concept to final launch, our Guelph web
                  ...
                  Guelph-based website is not only visually appealing but also
                  ...
                  and Guelph web design solutions, and watch your online
                  presence flourish.
                </p>
                <a
              ...
              <Col lg="6" className="d-block d-sm-none">
                <Image
                  className="img-fluid"
                  src={growth}
                  alt="website design company in Guelph"
                />
              </Col>
            </Row>
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6">
                ...
                <p>
                  Ready to transform your Guelph web design into a conversion
                  powerhouse? Our Conversion-Driven Web Design is expertly
                  crafted to do just that. At Infused Agency, we develop
                  stunning Guelph web design solutions that not only captivate
                  ...
                  calls-to-action, our Guelph web design experts create designs
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={discover}
                    alt="website design discovery Guelph"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={design}
                    alt="website design process Guelph"
                  />
                  <h2>
                    2. <span>Plan</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={realdesign}
                    alt="website design agency Guelph"
                  />
                  <h2>
                    3. <span>Design</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={dev}
                    alt="website development Guelph"
                  />
                  <h2>
                    4. <span>Develop</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={launch}
                    alt="website development launch Guelph"
                  />
                  <h2>
                    5. <span>Launch</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={promote}
                    alt="website design promotion Guelph"
                  />
                  <h2>
                    6. <span>Promote</span>
                  </h2>
          ...
          <Container>
            ...
            <Row className="pd-top-80">
              <Col md="6">
                <h2>
                  Our Guelph website designs are <span>fast</span>,{" "}
            ...
            <Row className="pd-top-40">
              <Col lg="4" className="d-flex">
                <div className="card">
                  <Image src={fast} alt="fast website design Guelph" />
                  <h3>Lightning-Fast Speed</h3>
                  <p>
                    Enjoy unparalleled website speed with Infused Agency’s web
                    design services in Guelph. Our websites are crafted to load
              ...
              <Col lg="4" className="d-flex">
                <div className="card">
                  <Image src={build} alt="web designers in Guelph" />
                  <h3>Mobile Performance</h3>
                  <p>
                    Experience a website that performs exceptionally across all
                    devices with Infused Agency’s Guelph web development. We
            ...
            <Row className="pd-top-40">
              <Col md="6">
                <h2>
                  How to <span>increase conversions</span> through Guelph
                  website design.
                </h2>
              </Col>
              <Col md="6">&nbsp;</Col>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={speed}
                    alt="website design speed Guelph"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={ux}
                    alt="website design user experience Guelph"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={opt}
                    alt="website design optimize landing page Guelph"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={testing}
                    alt="website design a/b testing Guelph"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={social}
                    alt="website design social proof Guelph"
                  />
                  <h2>
