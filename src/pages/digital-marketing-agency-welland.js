...
import intro from "../img/digital-marketing-agency-welland.webp";
...
import results from "../img/digital-marketing-agency-welland-results.webp";
import integ from "../img/welland-digital-marketing-agency.webp";
...
const SEO = () => {
  ...
  return (
    <>
      <Head>
        <title>Digital Marketing Agency Welland | Infused Agency</title>
        <meta
          name="description"
          content="Our digital marketing agency Welland team can help your business boost sales, leads and revenue. Get your free consultation today!"
        />
        <link
          rel="canonical"
          href="https://infused.agency/digital-marketing-agency-welland"
        />
      </Head>
      <Nav />
            ...
            <Row>
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h1 className="intro">Digital Marketing Agency Welland</h1>
                  <h2 className="sub">
                    Boost revenue, drive leads and get more sales for your
                    Welland company today!
                  </h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
            ...
            <Container>
              <Row>
                <Col lg="7">
                  ...
                  >
                    <h2>
                      A Digital Marketing Agency Welland Team That <br />
                      <span>Gets Results</span>
                    </h2>
                    <p>
                      At Infused Agency, our digital marketing agency Welland
                      team helps businesses in Welland grow through digital
                    ...
                    <p>
                      ...
                      Catharines, Welland Falls, Welland, and more. Our goal is
              ...
              <Row className="pd-top-80">
                ...
                <div className="col-lg-7">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <h2>A Welland Digital Marketing Agency With Integrity</h2>
                    <p>
                      At Infused Agency, our Welland digital marketing agency
                      ...
                      is. Our modern Welland digital marketing strategies are
              ...
              <div className="row pd-top-80 align-items-center">
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <h3>Our Digital Marketing Agency Welland Team</h3>
                    <p>
                      We have been helping businesses in Welland with our
                    ...
                    <p>
                      ...
                      <strong>understands the Welland area</strong>. We know how
                    ...
                    <p>
                      ...
                      people search for services in Welland. This means more
                    ...
                    <p>
                      ...
                      become a trusted digital marketing company for Welland
            ...
            <Container>
              <Row className="text-center">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      Our <span>Digital Marketing Services</span> in Welland
                    </h2>
                  </motion.div>
                </Col>
              </Row>
                ...
                <Row className="pd-top-40">
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      ...
                      <p>
                        Our digital marketing agency Welland team offers social
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      ...
                      <p>
                        ...
                        your business show up when people in Welland search for
                        services like yours. Our digital marketing agency
                        Welland team makes sure your website is optimized so
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      ...
                      <p>
                        ...
                        Our digital marketing agency Welland team uses special
            ...
            <Container>
                ...
                <Col lg="6">
                  ...
                  >
                    <h2 className="pd-btm-40">
                      ...
                      <span>Welland Digital Marketing Agency</span>
                    </h2>
                    <div className="card">
                      <img
              ...
              <Row className="text-center pd-top-80">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      <span>Frequently Asked</span> Welland Digital Marketing
                      Agency Questions{" "}
                    </h2>
                  </motion.div>
                </Col>
                    ...
                    <Accordion open={open} toggle={toggle}>
                      ...
                      <AccordionItem>
                        <AccordionHeader targetId="2">
                          How can your Welland digital marketing services help
                          my Welland business?
                        </AccordionHeader>
          ...
          <Container>
            <Row>
              <Col lg="12">
                ...
                >
                  <h2>
                    Delivering Digital Marketing Services surrounding Welland:
                  </h2>
            ...
            <Row className="text-center">
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2>Need Welland Digital Marketing Services?</h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
                  whileInView={{ opacity: 1, y: 0 }}
