...
import website from "../img/dundas-web-design.webp";
  ...
  return (
    <>
      ...
      <InnerHero
        ...
        description="Infused Agency is an award-winning web design company that serves Dundas. We help businesses bring in more revenue through their websites."
        bgImage={bgImage}
      />
      <InnerContent>
        <section className="seo-page">
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="Dundas web design company, Dundas web design agency, Dundas web design services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Dundas web design services</strong> that our{" "}
                  <strong>Dundas web design company</strong> provides are pretty
                ...
                <ul>
                  ...
                  <li>
                    Improves your Dundas company's reputation and
                    trustworthiness.
                  </li>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      By using their web design services, my Dundas company went
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      Dundas business I do recommend Infused Agency for their
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with top Dundas web design
                    services?
                  </h3>
          ...
          <section className="seo-services">
            <Container>
              <Row className="pd-top-80 pd-btm-40">
                <Col lg="12 text-center">
                  <h2>
                    Dundas <span>Web Design</span> Services
                  </h2>
              ...
              <Row>
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Dundas web designers create websites that bolster your
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    We conduct responsive web design as part of our Dundas web
                    design services to help your users navigate your website on
                    any device. Our Dundas web design experts specifically
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our web design company in Dundas uses WordPress for all
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website. With the help of our Dundas web design agency, your
                    e-commerce website can help sell your products online,
                    expanding your reach drastically. Leave it to our Dundas web
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Have Our Dundas Web Design Experts Help Today</h3>
                  <p>Click the button below to get your free quote.</p>
                  <a
                    target="_blank"
                    rel="noreferrer"
          ...
          <section className="seo-why pd-top-80">
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Dundas</span> Web
                    Design Agency
                  </h2>
                  <p>
