...
import kdImg from "../../img/fonthill-web-design.png";
  ...
  const schema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        url: "https://infused.agency/seo/fonthill",
      },
    ],
  };
...
const SEO = () => {
  return (
    <>
      ...
      <InnerHeroCities
        title="SEO Fonthill"
        subTitle="Your Local SEO Company in Fonthill"
        description="We offer top Fonthill SEO services, helping businesses appear in Google when people search. Get more traffic, and get more leads."
        image={hero}
        alt="seo fonthill"
      />
      <InnerContent>
            ...
            <Col lg="6">
              ...
              <p>
                ...
                <Link href="/posts/local-seo-tips-niagara">
                  important their Fonthill SEO is
                </Link>
                . We take time to teach our clients and work closely with them
                to achieve great results together.
              </p>
              <p>
                We know we’re better than most Fonthill SEO companies, and our
                success and{" "}
                <Link href="/reviews">growing list of happy clients</Link> prove
                it. Infused Agency was created to provide amazing SEO services
                in Fonthill, led by our skilled team.
              </p>
              <p>
                Born in Fonthill, founded in Fonthill, our SEO Fonthill team
                will help your business rank on Google!
              </p>
            </Col>
            <Col lg="6">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d23326.515787364173!2d-79.28544913241174!3d43.04533487069438!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d3495b85ab330f%3A0xa66b7f6644047a01!2sFonthill%2C%20Pelham%2C%20ON!5e0!3m2!1sen!2sca!4v1727231484351!5m2!1sen!2sca"
                width="100%"
                height="450"
                allowfullscreen=""
                loading="lazy"
                ...
                <div className="row align-items-center">
                  <div className="col-lg-6">
                    ...
                    <p>
                      ...
                      many brands and businesses in Fonthill and beyond.
                    </p>
                  </div>
                  <Col lg="6">
                    <Image
          ...
          <Container>
            ...
            <Row>
              <Col lg="4">
                ...
                <p>
                  Infused Agency's SEO Fonthill company conducts specific
              ...
              <Col lg="12">
                ...
                <p>
                  <strong>
                    ...
                    services in Fonthill.
                  </strong>
                </p>
                <p>
                  As one of the top SEO companies in Fonthill, we create and
              ...
              <Col lg="4">
                <div className="card">
                  ...
                  <p>
                    ...
                    their SEO Fonthill company if you are thinking of needing
                    their SEO services."
                  </p>
                  <ul>
                    <li>
            ...
            <Row>
              <Col lg="6">
                <p>
                  ...
                  <Link href="/digital-marketing-fonthill">
                    digital marketing
                  </Link>
                  , search engine optimization (SEO) ,{" "}
                  <Link href="/wordpress-developer-fonthill">
        ...
        <Container>
          <Row className="pd-top-80 pd-btm-60">
            <Col lg="12">
              ...
              <h3>Our SEO Fonthill Company is ready to help.</h3>
              <p>
