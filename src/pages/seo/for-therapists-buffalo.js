...
const Home = ({ latestPosts }) => {
  ...
  return (
    <>
      <Head>
        <title>
          #1 SEO for Therapists Buffalo | Counsellor & Therapy SEO Company
      ...
      <section className="new-york seo-city-hero">
        <Container>
          <Row className="align-items-center">
            <Col lg="12">
              <h1 className="intro">
                Buffalo SEO Company for Therapists - Buffalo Counsellor SEO
                Agency
              </h1>
              ...
              <p>
                ...
                therapist in Buffalo, Michigan, Massachusetts, Virginia, or
                anywhere else in the Buffalo, we'll help your therapy practice
                get more visibility.
              </p>
