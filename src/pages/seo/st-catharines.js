  ...
  const schema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        url: "https://infused.agency/seo/st. catharines",
      },
    ],
  };
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>
          SEO St. Catharines | Best SEO Company in St. Catharines, ON
        </title>
        <meta
          name="description"
          content="Top SEO St. Catharines services serving the St. Catharines Region since 2013. We help businesses of all sizes improve their SEO and get higher rankings. Grow your leads &amp; revenue today."
        />
      ...
      <InnerHeroCities
        ...
        subTitle="Your Local SEO Company in St. Catharines"
        description="We offer top St. Catharines SEO services, helping businesses appear in Google when people search. Get more traffic, and get more leads."
        image={hero}
        alt="seo st. catharines"
      />
      <InnerContent>
        <Container>
          <Row>
            <Col lg="6">
              ...
              <p>
                ...
                <Link href="/posts/local-seo-tips-niagara">
                  important their St. Catharines SEO is
                </Link>
                . We take time to teach our clients and work closely with them
                to achieve great results together.
              </p>
              <p>
                We know we’re better than most St. Catharines SEO companies, and
                our success and{" "}
                <Link href="/reviews">growing list of happy clients</Link> prove
                it. Infused Agency was created to provide amazing SEO services
                in St. Catharines, led by our skilled team.
              </p>
              <p>
                Born in St. Catharines, founded in St. Catharines, our SEO Port
                Colborne team will help your business rank on Google!
              </p>
            </Col>
            <Col lg="6">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d93132.42304665425!2d-79.2468625844151!3d43.15937450507583!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d35054bb6a5a4b%3A0x37563636c082837!2sSt.%20Catharines%2C%20ON!5e0!3m2!1sen!2sca!4v1727294214643!5m2!1sen!2sca"
                width="100%"
                height="450"
                allowfullscreen=""
                loading="lazy"
                ...
                <div className="row align-items-center">
                  <div className="col-lg-6">
                    ...
                    <p>
                      ...
                      many brands and businesses in St. Catharines and beyond.
                    </p>
                  </div>
                  <Col lg="6">
                    <Image
          ...
          <Container>
            <Row className="pd-btm-40">
              <Col lg="12 text-center">
                <h2>St. Catharines SEO Services</h2>
                <p>
            ...
            <Row>
              <Col lg="4">
                ...
                <p>
                  Infused Agency's SEO St. Catharines company conducts specific
          ...
          <Container>
            <Row>
              <Col lg="12">
                ...
                <p>
                  As one of the top SEO companies in St. Catharines, we create
              ...
              <Col lg="4">
                <div className="card">
                  ...
                  <p>
                    ...
                    their SEO St. Catharines company if you are thinking of
        ...
        <Container>
          <Row className="pd-top-80 pd-btm-60">
            <Col lg="12">
              ...
              <h3>Our SEO St. Catharines Company is ready to help.</h3>
              <p>
