...
import hero from "../../img/seo-wainfleet.webp";
  ...
  const schema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        url: "https://infused.agency/seo/wainfleet",
      },
    ],
  };
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>SEO Wainfleet | Best SEO Company in Wainfleet, ON</title>
        <meta
          name="description"
          content="Top SEO Wainfleet services serving the Wainfleet Region since 2013. We help businesses of all sizes improve their SEO and get higher rankings. Grow your leads &amp; revenue today."
        />
        <link rel="canonical" href="https://infused.agency/seo/wainfleet" />
        <script
      ...
      <InnerHeroCities
        title="SEO Wainfleet"
        subTitle="Your Local SEO Company in Wainfleet"
        description="We offer top Wainfleet SEO services, helping businesses appear in Google when people search. Get more traffic, and get more leads."
        image={hero}
        alt="seo wainfleet"
      />
      <InnerContent>
            ...
            <Col lg="6">
              ...
              <p>
                ...
                <Link href="/posts/local-seo-tips-niagara">
                  important their Wainfleet SEO is
                </Link>
                . We take time to teach our clients and work closely with them
                to achieve great results together.
              </p>
              <p>
                We know we’re better than most Wainfleet SEO companies, and our
                success and{" "}
                <Link href="/reviews">growing list of happy clients</Link> prove
                it. Infused Agency was created to provide amazing SEO services
                in Wainfleet, led by our skilled team.
              </p>
              <p>
                Born in Wainfleet, founded in Wainfleet, our SEO Wainfleet team
                will help your business rank on Google!
              </p>
            </Col>
            <Col lg="6">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11685.295526480639!2d-79.38230937596208!3d42.92929844958858!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d334b202bdff43%3A0xf2051a5eb1cbc6c8!2sWainfleet%2C%20ON!5e0!3m2!1sen!2sca!4v1727352478010!5m2!1sen!2sca"
                width="100%"
                height="450"
                allowfullscreen=""
                loading="lazy"
                ...
                <div className="row align-items-center">
                  <div className="col-lg-6">
                    ...
                    <p>
                      ...
                      many brands and businesses in Wainfleet and beyond.
                    </p>
                  </div>
                  <Col lg="6">
                    <Image
          ...
          <Container>
            ...
            <Row>
              <Col lg="4">
                ...
                <p>
                  Infused Agency's SEO Wainfleet company conducts specific
          ...
          <Container>
            <Row>
              <Col lg="12">
                ...
                <p>
                  As one of the top SEO companies in Wainfleet, we create and
              ...
              <Col lg="4">
                <div className="card">
                  ...
                  <p>
                    ...
                    their SEO Wainfleet company if you are thinking of needing
                    their SEO services."
                  </p>
                  <ul>
                    <li>
            ...
            <Row>
              <Col lg="6">
                <p>
                  ...
                  <Link href="/digital-marketing-wainfleet">
                    digital marketing
                  </Link>
                  , search engine optimization (SEO) ,{" "}
                  <Link href="/wordpress-developer-wainfleet">
        ...
        <Container>
          <Row className="pd-top-80 pd-btm-60">
            <Col lg="12">
              ...
              <h3>Our SEO Wainfleet Company is ready to help.</h3>
              <p>
