...
import intro from "../img/digital-marketing-agency-beamsville.webp";
...
import integ from "../img/beamsville-digital-marketing-agency.webp";
...
const SEO = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Digital Marketing Agency Beamsville-Lincoln | Infused Agency
        </title>
        <meta
          name="description"
          content="Our digital marketing agency Beamsville-Lincoln team can help your business boost sales, leads and revenue. Get your free consultation today!"
        />
        <link
          rel="canonical"
          href="https://infused.agency/digital-marketing-agency-beamsville"
        />
      </Head>
      <Nav />
            ...
            <Row>
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h1 className="intro">Digital Marketing Agency Beamsville</h1>
                  <h2 className="sub">
                    Boost revenue, drive leads and get more sales for your
                    Beamsville company today!
                  </h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
            ...
            <Container>
              <Row>
                <Col lg="7">
                  ...
                  >
                    <h2>
                      A Digital Marketing Agency Beamsville Team That <br />
                      <span>Gets Results</span>
                    </h2>
                    <p>
                      At Infused Agency, our digital marketing agency Beamsville
                      team helps businesses in Beamsville grow through digital
                    ...
                    <p>
                      ...
                      Catharines, Beamsville Falls, Welland, and more. Our goal
                ...
                <Col lg="5">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={intro}
                      alt="digital marketing agency beamsville"
                    />
                    <br />
                    <br />
                    <iframe
              ...
              <Row className="pd-top-80">
                <div className="col-lg-5">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={integ}
                      alt="beamsville digital marketing agency"
                    />
                  </motion.div>
                </div>
                <div className="col-lg-7">
                  ...
                  >
                    <h2>
                      A Beamsville Digital Marketing Agency With Integrity
                    </h2>
                    <p>
                      At Infused Agency, our Beamsville digital marketing agency
                      ...
                      is. Our modern Beamsville digital marketing strategies are
              ...
              <div className="row pd-top-80 align-items-center">
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <h3>Our Digital Marketing Agency Beamsville Team</h3>
                    <p>
                      We have been helping businesses in Beamsville with our
                    ...
                    <p>
                      ...
                      <strong>understands the Beamsville area</strong>. We know
                    ...
                    <p>
                      ...
                      people search for services in Beamsville. This means more
                    ...
                    <p>
                      ...
                      become a trusted digital marketing company for Beamsville
                    ...
                    <Image
                      className="img-fluid"
                      src={best}
                      alt="digital marketing company beamsville"
                    />
                  </motion.div>
                </div>
                <div className="col-lg-6">
            ...
            <Container>
              <Row className="text-center">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      Our <span>Digital Marketing Services</span> in Beamsville
                    </h2>
                  </motion.div>
                </Col>
              </Row>
                ...
                <Row className="pd-top-40">
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image
                        src={img1}
                        alt="social media marketing beamsville"
                      />
                      <h3>Social Media Ads Marketing</h3>
                      <p>
                        Our digital marketing agency Beamsville team offers
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img2} alt="local seo marketing beamsville" />
                      <h3>Local SEO Marketing</h3>
                      <p>
                        Our local SEO marketing service is all about helping
                        your business show up when people in Beamsville search
                        for services like yours. Our digital marketing agency
                        Beamsville team makes sure your website is optimized so
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image
                        src={img3}
                        alt="search engine marketing beamsville"
                      />
                      ...
                      <p>
                        ...
                        Our digital marketing agency Beamsville team uses
            ...
            <Container>
                ...
                <Col lg="6">
                  ...
                  >
                    <h2 className="pd-btm-40">
                      ...
                      <span>Beamsville Digital Marketing Agency</span>
                    </h2>
                    <div className="card">
                      <img
              ...
              <Row className="text-center pd-top-80">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      <span>Frequently Asked</span> Beamsville Digital Marketing
                      Agency Questions{" "}
                    </h2>
                  </motion.div>
                </Col>
                    ...
                    <Accordion open={open} toggle={toggle}>
                      ...
                      <AccordionItem>
                        <AccordionHeader targetId="2">
                          How can your Beamsville digital marketing services
                          help my Beamsville business?
                        </AccordionHeader>
