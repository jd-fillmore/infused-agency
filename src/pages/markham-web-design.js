...
const WebDesign = () => {
  return (
    <>
      <Head>
        <title>Markham Web Design 🥇 Best Web Design Company in Markham, ON | Infused Agency</title>
        <meta
          name="description"
            ...
            <Row className="pd-top-80 pd-btm-80">
              ...
              <Col lg="6">
                <p>
                  ...
                  Markham market. Choose Infused Agency for cutting-edge web
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6" className="order-1 order-lg-2">
                ...
                <p>
                  ...
                  Markham-based website is not only visually appealing but also
                  ...
                  Markham web design solutions, and watch your online presence
                  flourish.
                </p>
                <a
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6">
                ...
                <p>
                  ...
                  calls-to-action, our Markham web design experts create
              ...
              <Col lg="4" className="d-flex">
                <div className="card">
                  ...
                  <p>
                    ...
                    design services in Markham. Our websites are crafted to
