...
import intro from "../img/ontario-arborist-tree-removal-website-design.webp";
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://infused.agency/ontario-arborist-tree-removal-websites"
        />
      </Head>
      <Nav />
        ...
        <section className="niche-inner-hero arborist-hero">
          <Container>
            <Row className="text-center">
              <Col lg="12">
                <h1>
                  Professional Websites for Ontario Arborists & Tree Removal
                  Services
                </h1>
                <h2>
          ...
          <div className="niche-services pd-top-80">
            <Container>
              <Row className="text-center w-80">
                <Col lg="12">
                  <h2>
                    Ontario Arborist and Tree Removal Service Website Solutions{" "}
              ...
              <Row className="pd-top-40">
                <Col lg="6" className="d-flex">
                  <div className="card">
                    <Image
                      src={disc}
                      alt="ontario arborist &amp; tree removal service discovery call"
                    />
                ...
                <Col lg="6">
                  <div className="card">
                    <Image
                      src={des}
                      alt="ontario arborist &amp; tree removal service design"
                    />
                    <h3>Web Design</h3>
                    <ul>
                      <li>
              ...
              <Row>
                <Col lg="6">
                  <div className="card">
                    <Image
                      src={dev}
                      alt="ontario arborist &amp; tree removal service web development"
                    />
                ...
                <Col lg="6">
                  <div className="card">
                    <Image
                      src={launch}
                      alt="ontario arborist &amp; tree removal website design launch"
                    />
