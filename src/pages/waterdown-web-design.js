...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert web design services, including lead generation, development, and online marketing in Waterdown, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Our Nearby Waterdown Web Design Clients{" "}
