...
import website from "../img/hamilton-seo.webp";
...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert Hamilton SEO services, including lead generation, development, and online marketing in Hamilton, Canada.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Hamilton SEO | Steel City's Premier Digital Marketers</title>
        <meta
          name="description"
        ...
        <section className="seo-page">
          <Container>
            <Row>
              <Col md="6">
                <h2>
                  Hamilton SEO crafted to <span>engage</span>,{" "}
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="Hamilton seo company, Hamilton seo services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Hamilton SEO services</strong> that our{" "}
                  <strong>Hamilton SEO company</strong> provides are pretty
                ...
                <ul>
                  ...
                  <li>Improves your Hamilton brand's awareness.</li>
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with our Hamilton SEO Firm?
                  </h3>
            ...
            <Container>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    Infused Agency's Hamilton SEO services conducts specific
                ...
                <Col lg="4">
                  <h5>Link Building</h5>
                  <p>
                    Off of your website, our Hamilton SEO experts utilize
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Hamilton SEO services are conducted by a highly trained
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    ...
                    user experience. This is why our Hamilton SEO agency looks
                ...
                <Col lg="4">
                  <h5>Local SEO</h5>
                  <p>
                    For a more local approach, our Hamilton SEO specialists can
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website, our Hamilton SEO experts are here to help. We'll
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Have Our Hamilton SEO Company Help Today</h3>
                  <p>Click the button below to get your free quote.</p>
                  <a
                    target="_blank"
                    rel="noreferrer"
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Hamilton</span> SEO
                    Agency
                  </h2>
          ...
          <Container>
            <Row className="pd-top-80 pd-btm-60">
              <Col lg="12">
                ...
                <p>
                  ...
                  absolutely you need a Hamilton SEO company to help you with
                  SEO services. It's important that our Hamilton SEO experts
                ...
                <h3>Our Hamilton SEO company is ready to help.</h3>
                <p>
                  If you need our Hamilton SEO company to help your company rise
            ...
            <Row className="pd-top-40">
              <Col md="6">
                <h2>
                  How to <span>increase conversions</span> using our Hamilton
                  SEO Company.
                </h2>
              </Col>
              <Col md="6">&nbsp;</Col>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={testing}
                      alt="Hamilton seo company services"
                    />
                    <h2>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={social}
                      alt="search engine optimization Hamilton"
                    />
                    <h2>
            ...
            <Row>
              <Col lg="12">
                ...
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d743844.4440140255!2d-80.59253202442173!3d43.258916745813835!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882c986c27de778f%3A0x2b6aee56d8df0e21!2sHamilton%2C%20ON!5e0!3m2!1sen!2sca!4v1723511464499!5m2!1sen!2sca"
                  width="100%"
                  height="450"
                  allowfullscreen=""
                  loading="lazy"
