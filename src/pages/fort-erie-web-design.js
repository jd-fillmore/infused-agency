...
import intro from "../img/web-design-fort-erie.webp";
...
import results from "../img/web-design-fort-erie-results.webp";
import integ from "../img/fort-erie-web-design-agency.webp";
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>
          Web Design Fort Erie | Website Developer Fort Erie | Award Winning |
          Affordable Fort Erie Web Design | Infused Agency | Website Design Fort
          Erie, Fort Erie Web Design Company, Fort Erie Web Designer, Web Design
          Fort Erie Ontario
        </title>
        <meta
          name="description"
          content="Our web design Fort Erie team makes websites to increase your company's sales. Click here for your free Fort Erie web design quote!"
        />
        <link
          rel="canonical"
            ...
            <Row>
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h1 className="intro">Web Design Fort Erie</h1>
                  <h2 className="sub">
                    We create Fort Erie web designs that attract visitors and
                    turn them into leads, helping your Fort Erie business grow.
                  </h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
            ...
            <Container>
              <Row>
                <Col lg="7">
                  ...
                  >
                    <h2>
                      A Web Design Fort Erie Agency That{" "}
                      <span>Gets Results</span>
                    </h2>
                    <p>
                      At Infused Agency, our web design Fort Erie team helps
                      local businesses grow with amazing websites. We create
                      custom Fort Erie web design websites to boost your brand
                    ...
                    <p>
                      We have helped many businesses in the Fort Erie area with
              ...
              <Row className="pd-top-80 align-items-center">
                ...
                <div className="col-lg-7">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <h2>A Fort Erie Web Design Agency With Integrity</h2>
                    <p>
                      At Infused Agency, our Fort Erie web design agency helps
                    ...
                    <ul>
                      <li>
                        <strong>Custom Web Design</strong>: Our web design Fort
                        Erie team makes great websites just for you. Our custom
                        web design makes sure your site stands out and shows off
              ...
              <div className="row pd-top-80 align-items-center">
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <h3>Our Web Design Fort Erie Team</h3>
                    <p>
                      Our web design Fort Erie team has been helping businesses
                      in Fort Erie with web design for{" "}
                    ...
                    <p>
                      When you choose us,{" "}
                      <strong>
                        you get a team that knows all about Fort Erie
                      </strong>
                    ...
                    <p>
                      ...
                      <strong>trusted web design company</strong> for Fort Erie
                    ...
                    <Image
                      className="img-fluid"
                      src={best}
                      alt="web design company fort erie-lincoln"
                    />
                  </motion.div>
                </div>
                <div className="col-lg-6">
                  ...
                  >
                    <div className="card">
                      <img
                        alt="web design agency fort erie client review"
                        width="48"
                        height="48"
            ...
            <Container>
              <Row className="text-center">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      Our Fort Erie <span>Web Design Services</span>
                    </h2>
                  </motion.div>
                </Col>
              </Row>
              ...
              >
                <Row className="pd-top-40">
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img1} alt="web design fort erie company" />
                      <h3>Web Design</h3>
                      <p>
                        Our Fort Erie web designs make sure that visitors have a
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img2} alt="wordpress web design fort erie" />
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img3} alt="web development fort erie" />
            ...
            <Container>
                ...
                <Col lg="6">
                  ...
                  >
                    <h2 className="pd-btm-40">
                      ...
                      <span>Fort Erie Web Design Agency</span>
                    </h2>
                    <div className="card">
                      <img
                        alt="fort erie web design agency client testimonial"
                        width="48"
                        height="48"
                        src="https://lh3.googleusercontent.com/a/ACg8ocIKt9X9LSKomYMvAkQn_0673Xwg0EBOP-QigGk1AaAVHdVIvA=w48-h48-p-rp-mo-ba3-br100"
                      />
                ...
                <Col lg="6">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={results}
                      alt="fort erie web design agency case study"
                    />
                  </motion.div>
                </Col>
              </Row>
              ...
              <Row className="text-center pd-top-80">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      <span>Frequently Asked</span> Fort Erie Web Design Agency
                      Questions{" "}
                    </h2>
                  </motion.div>
                </Col>
            ...
            <Row>
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2>Delivering Web Design Services surrounding Fort Erie:</h2>
            ...
            <Row className="text-center">
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2>Need Fort Erie Web Design Services?</h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
                  whileInView={{ opacity: 1, y: 0 }}
