...
import intro from "../img/digital-marketing-agency-thorold.webp";
...
import results from "../img/digital-marketing-agency-thorold-results.webp";
import integ from "../img/thorold-digital-marketing-agency.webp";
...
const SEO = () => {
  ...
  return (
    <>
      <Head>
        <title>Digital Marketing Agency Thorold | Infused Agency</title>
        <meta
          name="description"
          content="Our digital marketing agency Thorold team can help your business boost sales, leads and revenue. Get your free consultation today!"
        />
        <link
          rel="canonical"
          href="https://infused.agency/digital-marketing-agency-thorold"
        />
      </Head>
      <Nav />
            ...
            <Row>
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h1 className="intro">Digital Marketing Agency Thorold</h1>
                  <h2 className="sub">
                    Boost revenue, drive leads and get more sales for your
                    Thorold company today!
                  </h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
            ...
            <Container>
              <Row>
                <Col lg="7">
                  ...
                  >
                    <h2>
                      A Digital Marketing Agency Thorold Team That <br />
                      <span>Gets Results</span>
                    </h2>
                    <p>
                      At Infused Agency, our digital marketing agency Thorold
                      team helps businesses in Thorold grow through digital
                    ...
                    <p>
                      ...
                      Catharines, Thorold Falls, Welland, and more. Our goal is
                ...
                <Col lg="5">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={intro}
                      alt="digital marketing agency thorold"
                    />
                    <br />
                    <br />
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d93247.42070136285!2d-79.31022917577538!3d43.083875939794495!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d34ff27154bc97%3A0x3b0d481719e3e990!2sThorold%2C%20ON!5e0!3m2!1sen!2sca!4v1726060745068!5m2!1sen!2sca"
                      width="100%"
                      height="450"
                      allowfullscreen=""
                      loading="lazy"
              ...
              <Row className="pd-top-80">
                <div className="col-lg-5">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={integ}
                      alt="thorold digital marketing agency"
                    />
                  </motion.div>
                </div>
                <div className="col-lg-7">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <h2>A Thorold Digital Marketing Agency With Integrity</h2>
                    <p>
                      At Infused Agency, our Thorold digital marketing agency
              ...
              <div className="row pd-top-80 align-items-center">
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <h3>Our Digital Marketing Agency Thorold Team</h3>
                    <p>
                      We have been helping businesses in Thorold with our
                    ...
                    <p>
                      ...
                      <strong>understands the Thorold area</strong>. We know how
                    ...
                    <p>
                      ...
                      people search for services in Thorold. This means more
                    ...
                    <p>
                      ...
                      become a trusted digital marketing company for Thorold
                    ...
                    <Image
                      className="img-fluid"
                      src={best}
                      alt="digital marketing company thorold"
                    />
                  </motion.div>
                </div>
                <div className="col-lg-6">
                  ...
                  >
                    <div className="card">
                      <img
                        alt="digital marketing agency thorold client review"
                        width="48"
                        height="48"
            ...
            <Container>
              <Row className="text-center">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      Our <span>Digital Marketing Services</span> in Thorold
                    </h2>
                  </motion.div>
                </Col>
              </Row>
              ...
              >
                <Row className="pd-top-40">
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img1} alt="social media marketing thorold" />
                      <h3>Social Media Ads Marketing</h3>
                      <p>
                        Our digital marketing agency Thorold team offers social
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img2} alt="local seo marketing thorold" />
                      <h3>Local SEO Marketing</h3>
                      <p>
                        Our local SEO marketing service is all about helping
                        your business show up when people in Thorold search for
                        services like yours. Our digital marketing agency
                        Thorold team makes sure your website is optimized so
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img3} alt="search engine marketing thorold" />
                      ...
                      <p>
                        ...
                        Our digital marketing agency Thorold team uses special
            ...
            <Container>
                ...
                <Col lg="6">
                  ...
                  >
                    <h2 className="pd-btm-40">
                      ...
                      <span>Thorold Digital Marketing Agency</span>
                    </h2>
                    <div className="card">
                      <img
                        alt="thorold digital marketing agency client testimonial"
                        width="48"
                        height="48"
                        src="https://lh3.googleusercontent.com/a/ACg8ocIKt9X9LSKomYMvAkQn_0673Xwg0EBOP-QigGk1AaAVHdVIvA=w48-h48-p-rp-mo-ba3-br100"
                      />
                ...
                <Col lg="6">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={results}
                      alt="thorold digital marketing agency case study"
                    />
                  </motion.div>
                </Col>
              </Row>
              ...
              <Row className="text-center pd-top-80">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      <span>Frequently Asked</span> Thorold Digital Marketing
                      Agency Questions{" "}
                    </h2>
                  </motion.div>
                </Col>
                    ...
                    <Accordion open={open} toggle={toggle}>
                      ...
                      <AccordionItem>
                        <AccordionHeader targetId="2">
                          How can your Thorold digital marketing services help
                          my Thorold business?
                        </AccordionHeader>
          ...
          <Container>
            <Row>
              <Col lg="12">
                ...
                >
                  <h2>
                    Delivering Digital Marketing Services surrounding Thorold:
                  </h2>
            ...
            <Row className="text-center">
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2>Need Thorold Digital Marketing Services?</h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
                  whileInView={{ opacity: 1, y: 0 }}
