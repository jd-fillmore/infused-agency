...
const SEO = ({ latestPosts }) => {
  return (
    <>
      <Head>
        <title>
          SEO & Digital Marketing Services in Thorold, ON | Infused Agency
        </title>
        <meta
          name="description"
          content="Grow your Thorold business with tailored SEO and digital marketing strategies. Infused Agency helps local companies attract more customers and increase online presence."
        />
        <link rel="canonical" href="https://infused.agency/thorold" />
      </Head>
      <Nav />
      <InnerHeroCities
