...
import intro from "../img/digital-marketing-agency-wainfleet.webp";
...
import results from "../img/digital-marketing-agency-wainfleet-results.webp";
import integ from "../img/wainfleet-digital-marketing-agency.webp";
...
const SEO = () => {
  ...
  return (
    <>
      <Head>
        <title>Digital Marketing Agency Wainfleet | Infused Agency</title>
        <meta
          name="description"
          content="Our digital marketing agency Wainfleet team can help your business boost sales, leads and revenue. Get your free consultation today!"
        />
        <link
          rel="canonical"
          href="https://infused.agency/digital-marketing-agency-wainfleet"
        />
      </Head>
      <Nav />
            ...
            <Row>
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h1 className="intro">Digital Marketing Agency Wainfleet</h1>
                  <h2 className="sub">
                    Boost revenue, drive leads and get more sales for your
                    Wainfleet company today!
                  </h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
            ...
            <Container>
              <Row>
                <Col lg="7">
                  ...
                  >
                    <h2>
                      A Digital Marketing Agency Wainfleet Team That <br />
                      <span>Gets Results</span>
                    </h2>
                    <p>
                      At Infused Agency, our digital marketing agency Wainfleet
                      team helps businesses in Wainfleet grow through digital
                    ...
                    <p>
                      ...
                      Catharines, Wainfleet Falls, Welland, and more. Our goal
                ...
                <Col lg="5">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={intro}
                      alt="digital marketing agency wainfleet"
                    />
                    <br />
                    <br />
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d23370.587165593664!2d-79.40891780114353!3d42.929308694947366!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d334b202bdff43%3A0xf2051a5eb1cbc6c8!2sWainfleet%2C%20ON!5e0!3m2!1sen!2sca!4v1726060959180!5m2!1sen!2sca"
                      width="100%"
                      height="450"
                      allowfullscreen=""
                      loading="lazy"
              ...
              <Row className="pd-top-80">
                <div className="col-lg-5">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={integ}
                      alt="wainfleet digital marketing agency"
                    />
                  </motion.div>
                </div>
                <div className="col-lg-7">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <h2>A Wainfleet Digital Marketing Agency With Integrity</h2>
                    <p>
                      At Infused Agency, our Wainfleet digital marketing agency
              ...
              <div className="row pd-top-80 align-items-center">
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <h3>Our Digital Marketing Agency Wainfleet Team</h3>
                    <p>
                      We have been helping businesses in Wainfleet with our
                    ...
                    <p>
                      ...
                      <strong>understands the Wainfleet area</strong>. We know
                    ...
                    <p>
                      ...
                      people search for services in Wainfleet. This means more
                    ...
                    <p>
                      ...
                      become a trusted digital marketing company for Wainfleet
                    ...
                    <Image
                      className="img-fluid"
                      src={best}
                      alt="digital marketing company wainfleet"
                    />
                  </motion.div>
                </div>
                <div className="col-lg-6">
                  ...
                  >
                    <div className="card">
                      <img
                        alt="digital marketing agency wainfleet client review"
                        width="48"
                        height="48"
            ...
            <Container>
              <Row className="text-center">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      Our <span>Digital Marketing Services</span> in Wainfleet
                    </h2>
                  </motion.div>
                </Col>
              </Row>
                ...
                <Row className="pd-top-40">
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image
                        src={img1}
                        alt="social media marketing wainfleet"
                      />
                      <h3>Social Media Ads Marketing</h3>
                      <p>
                        Our digital marketing agency Wainfleet team offers
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img2} alt="local seo marketing wainfleet" />
                      <h3>Local SEO Marketing</h3>
                      <p>
                        Our local SEO marketing service is all about helping
                        your business show up when people in Wainfleet search
                        for services like yours. Our digital marketing agency
                        Wainfleet team makes sure your website is optimized so
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image
                        src={img3}
                        alt="search engine marketing wainfleet"
                      />
                      ...
                      <p>
                        ...
                        Our digital marketing agency Wainfleet team uses special
            ...
            <Container>
                ...
                <Col lg="6">
                  ...
                  >
                    <h2 className="pd-btm-40">
                      ...
                      <span>Wainfleet Digital Marketing Agency</span>
                    </h2>
                    <div className="card">
                      <img
                        alt="wainfleet digital marketing agency client testimonial"
                        width="48"
                        height="48"
                        src="https://lh3.googleusercontent.com/a/ACg8ocIKt9X9LSKomYMvAkQn_0673Xwg0EBOP-QigGk1AaAVHdVIvA=w48-h48-p-rp-mo-ba3-br100"
                      />
                ...
                <Col lg="6">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={results}
                      alt="wainfleet digital marketing agency case study"
                    />
                  </motion.div>
                </Col>
              </Row>
              ...
              <Row className="text-center pd-top-80">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      <span>Frequently Asked</span> Wainfleet Digital Marketing
                      Agency Questions{" "}
                    </h2>
                  </motion.div>
                </Col>
                    ...
                    <Accordion open={open} toggle={toggle}>
                      ...
                      <AccordionItem>
                        <AccordionHeader targetId="2">
                          How can your Wainfleet digital marketing services help
                          my Wainfleet business?
                        </AccordionHeader>
                        <AccordionBody accordionId="2">
                          <h2>
                            How can your Wainfleet digital marketing services
                            help my Wainfleet business?
                          </h2>
                          <p>
          ...
          <Container>
            <Row>
              <Col lg="12">
                ...
                >
                  <h2>
                    Delivering Digital Marketing Services surrounding Wainfleet:
                  </h2>
            ...
            <Row className="text-center">
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2>Need Wainfleet Digital Marketing Services?</h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
                  whileInView={{ opacity: 1, y: 0 }}
