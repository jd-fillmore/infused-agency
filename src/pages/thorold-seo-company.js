...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert SEO services, including lead generation, search engine optimization, and online marketing in Thorold, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Thorold SEO 🥇 Best SEO Company in Thorold, ON | Infused Agency</title>
        <meta
          name="description"
            ...
            <Container>
              ...
              <Row>
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Thorold SEO services are conducted by a highly trained
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    ...
                    user experience. This is why our Thorold SEO agency looks
                ...
                <Col lg="4">
                  <h5>Local SEO</h5>
                  <p>
                    For a more local approach, our Thorold SEO specialists can
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website, our Thorold SEO experts are here to help. We'll
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Thorold</span> SEO
                    Agency
                  </h2>
            ...
            <Row className="pd-top-80 pd-btm-60">
              <Col lg="12">
                ...
                <p>
                  ...
                  absolutely you need a Thorold SEO company to help you with SEO
                  services. It's important that our Thorold SEO experts help
