...
import intro from "../img/alberta-arborist-tree-removal-website-design.webp";
...
const OntarioArborist = () => {
  return (
    <>
      <Head>
        <title>
          Arborist Website Design for Calgary, Edmonton &amp; Alberta Arborists
        ...
        <section className="niche-inner-hero arborist-hero">
          <Container>
            <Row className="text-center">
              <Col lg="12">
                <h1>
                  Professional Websites for Alberta Arborists & Tree Removal
                  Services
                </h1>
                <h2>
                  Get the Arborist Tree Removal Website You Need to Thrive.
                </h2>
                <h3>
                  Calgary - Edmonton - Red Deer - Lethbridge - St. Albert and
                  across Alberta
                </h3>
              ...
              <Row>
                <Col lg="6">
                  <Image
                    className="img-fluid"
                    src={intro}
                    alt="calgary, edmonton arborist tree removal website design services"
                  />
                </Col>
                <Col lg="6">
                  <p>
          ...
          <div className="niche-services pd-top-80">
            <Container>
              <Row className="text-center w-80">
                <Col lg="12">
                  <h2>
                    Alberta Arborist and Tree Removal Service Website Solutions{" "}
              ...
              <Row className="pd-top-40">
                <Col lg="6" className="d-flex">
                  <div className="card">
                    <Image
                      src={disc}
                      alt="alberta arborist &amp; tree removal service discovery call"
                    />
                ...
                <Col lg="6">
                  <div className="card">
                    <Image
                      src={des}
                      alt="alberta arborist &amp; tree removal service design"
                    />
                    <h3>Web Design</h3>
                    <ul>
                      <li>
              ...
              <Row>
                <Col lg="6">
                  <div className="card">
                    <Image
                      src={dev}
                      alt="alberta arborist &amp; tree removal service web development"
                    />
                ...
                <Col lg="6">
                  <div className="card">
                    <Image
                      src={launch}
                      alt="alberta arborist &amp; tree removal website design launch"
                    />
          ...
          <div className="niche-why pd-top-80">
            <Container>
              <Row className="text-center w-80">
                <Col lg="12">
                  <h2>
                    Why Choose <span>Infused Agency</span> As Your Alberta
              ...
              <Row className="pd-top-40">
                ...
                <Col lg="6">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4758543.677078181!2d-120.27573575727119!3d54.383347738082946!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x5309b282a82419b5%3A0xb0a9479a409b8e9e!2sAlberta!5e0!3m2!1sen!2sca!4v1720489480757!5m2!1sen!2sca"
                    width="100%"
                    height="450"
                    allowfullscreen=""
                    loading="lazy"
