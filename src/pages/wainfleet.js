...
const SEO = ({ latestPosts }) => {
  return (
    <>
      <Head>
        <title>
          Wainfleet SEO & Digital Marketing | Local Business Growth Experts
        </title>
        <meta
          name="description"
          content="Infused Agency provides expert SEO and digital marketing services in Wainfleet. Let us help your business rank higher and generate more qualified leads locally."
        />
        <link rel="canonical" href="https://infused.agency/wainfleet" />
      </Head>
      <Nav />
      <InnerHeroCities
