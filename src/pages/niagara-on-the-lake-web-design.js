...
import website from "../img/niagara-on-the-lake-web-design.webp";
  ...
  return (
    <>
      ...
      <InnerHero
        ...
        description="Infused Agency is an award-winning web design company that serves Niagara-on-the-Lake. We help businesses bring in more revenue through their websites."
        bgImage={bgImage}
      />
      <InnerContent>
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="Niagara-on-the-Lake web design company, Niagara-on-the-Lake web design agency, Niagara-on-the-Lake web design services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Niagara-on-the-Lake web design services</strong>{" "}
                  that our{" "}
                  <strong>Niagara-on-the-Lake web design company</strong>{" "}
                  provides are pretty impeccable. We consistently provide great
                  web design services to our clients with pretty awesome
                  results. There are a lot of benefits as to why web design
                  services are so important for any local company:
                </p>
                <ul>
                  <li>Helps bolster company branding.</li>
                  <li>
                    Improves your Niagara-on-the-Lake company's reputation and
                    trustworthiness.
                  </li>
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Our Niagara-on-the-Lake Web Design Clients{" "}
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      Niagara-on-the-Lake web design services."
                    </p>
                    <ul>
                      <li>
                        <strong>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      By using their web design services, my Niagara-on-the-Lake
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with top Niagara-on-the-Lake web
                    design services?
                  </h3>
          ...
          <section className="seo-services">
            <Container>
              <Row className="pd-top-80 pd-btm-40">
                <Col lg="12 text-center">
                  <h2>
                    Niagara-on-the-Lake <span>Web Design</span> Services
                  </h2>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    ...
                    key part of our Niagara-on-the-Lake web design services to
                    help make sure that your customers can find your website.
                    When using our Niagara-on-the-Lake web design experts and{" "}
                    <Link href="/Niagara-on-the-Lake-seo/">
                      Niagara-on-the-Lake SEO services
                    </Link>
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Niagara-on-the-Lake web designers create websites that
                    bolster your brand's reputation, which help bring in more
                    customers. Our websites not only attract customers, our
                    award-winning web designs take into account search engine
                    optimization and responsive web design best practices to
                ...
                <Col lg="4">
                  ...
                  <p>
                    Every client website we design is custom. Our
                    Niagara-on-the-Lake web designers will create a modern
                    website design for you, taking into consideration your
                    business goals. We make sure to plug in your vision that
                    factors into our Niagara-on-the-Lake web design experts’
                    design process.{" "}
                  </p>
                </Col>
              </Row>
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    We conduct responsive web design as part of our
                    Niagara-on-the-Lake web design services to help your users
                    navigate your website on any device. Our Niagara-on-the-Lake
                    web design experts specifically develop with custom code to
                    allow your website to look great on any device or computer.
                  </p>
                </Col>
                <Col lg="4">
                  <h5>WordPress Web Design</h5>
                  <p>
                    Our web design company in Niagara-on-the-Lake uses WordPress
                    for all website projects that require a content management
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website. With the help of our Niagara-on-the-Lake web design
                    agency, your e-commerce website can help sell your products
                    online, expanding your reach drastically. Leave it to our
                    Niagara-on-the-Lake web designers to help design and develop
                    a beautiful, modern online store.
                  </p>
                </Col>
              </Row>
            </Container>
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Have Our Niagara-on-the-Lake Web Design Experts Help Today
                  </h3>
                  <p>Click the button below to get your free quote.</p>
                  <a
                    target="_blank"
              ...
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    ...
                    <span>Niagara-on-the-Lake</span> Web Design Agency
                  </h2>
                  <p>
