  ...
  return (
    <>
      <Head>
        ...
        />
        <link rel="canonical" href="https://infused.agency/alliston-web-design" />
      </Head>
      <Nav />
      <InnerHero
            ...
            <Row className="web pd-btm-80">
              ...
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  ...
                  <strong>Alliston web design company</strong> provides are pretty impeccable. We consistently provide
                ...
                <ul>
                  ...
                  <li>Improves your Alliston company's reputation and trustworthiness.</li>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      highly recommend their company if you are thinking of needing their Alliston web design services."
                    </p>
                    <ul>
                      <li>
                        <strong>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      Alliston company went from having no website at all to one that brings in new customers every
                      week."
                    </p>
                    <ul>
                      <li>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      web design for your Alliston business I do recommend Infused Agency for their services. JD keep up
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Ready to grow your business with top Alliston web design services?</h3>
            ...
            <Container>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    ...
                    engine optimization is a key part of our Alliston web design services to help make sure that your
                    customers can find your website. When using our Alliston web design experts and{" "}
                    <Link href="/alliston-seo/">Alliston SEO services</Link>, your website should help bring in new
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Alliston web designers create websites that bolster your brand's reputation, which help bring in
                ...
                <Col lg="4">
                  ...
                  <p>
                    Every client website we design is custom. Our Alliston web designers will create a modern website
                    design for you, taking into consideration your business goals. We make sure to plug in your vision
                    that factors into our Alliston web design experts’ design process.{" "}
                  </p>
                </Col>
              </Row>
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    We conduct responsive web design as part of our Alliston web design services to help your users
                    navigate your website on any device. Our Alliston web design experts specifically develop with
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our web design company in Alliston uses WordPress for all website projects that require a content
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    have an e-commerce website. With the help of our Alliston web design agency, your e-commerce website
                    can help sell your products online, expanding your reach drastically. Leave it to our Alliston web
          ...
          <section className="seo-why pd-top-80">
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Alliston</span> Web Design Agency
                  </h2>
              ...
              <Row>
                <Col lg="6">
                  <p>
                    ...
                    <Link href="/alliston-seo/">search engine optimization (SEO)</Link> and {""}
