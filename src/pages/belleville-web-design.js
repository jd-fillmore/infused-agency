...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert web design services, including lead generation, development, and online marketing in Belleville, Canada.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const WebDesign = () => {
  return (
    <>
      <Head>
        <title>Belleville Web Design | Infused Agency</title>
        <meta
          name="description"
