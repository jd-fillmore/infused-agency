...
import intro from "../img/belleville-web-design.webp";
...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert web design services, including lead generation, development, and online marketing in Belleville, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const WebDesign = () => {
  return (
    <>
      <Head>
        <title>Belleville Web Design 🥇 Best Web Design Company in Belleville, ON | Infused Agency</title>
        <meta
          name="description"
          content="Top Belleville web design by Infused Agency. Expert website design services to enhance your online presence. Get a free quote today!"
        />
        <meta
          property="og:title"
          content="Web Design Belleville | Infused Agency"
        />
        <meta
          name="twitter:title"
          content="Web Design Belleville | Infused Agency"
        ...
        <link
          rel="canonical"
          href="https://infused.agency/belleville-web-design"
        />
        <script
        ...
        <section className="web-design">
          <Container>
            ...
            <Row>
              <Col md="6">
                <h2>
                  Belleville website design crafted to <span>engage</span>,{" "}
            ...
            <Row className="pd-top-80 pd-btm-80">
              <Col lg="6">
                <Image
                  className="img-fluid"
                  src={intro}
                  alt="web design Belleville conversion"
                />
              </Col>
              <Col lg="6">
                <p>
                  At Infused Agency, our Belleville web design services are
                  ...
                  Belleville-based businesses. Our team of expert web designers is
                  ...
                  Belleville market. Choose Infused Agency for cutting-edge web
            ...
            <div className="niche-services pd-top-40">
              <Row className="text-center w-80">
                <Col lg="12">
                  <h2>
                    Our Belleville Web Design Company Will
                    <br />
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6" className="order-1 order-lg-2">
                ...
                <p>
                  ...
                  in Belleville through our outstanding lead-generation web design
                  services. From initial concept to final launch, our Belleville
                  ...
                  Belleville-based website is not only visually appealing but also
                  ...
                  Belleville web design solutions, and watch your online presence
                  flourish.
                </p>
                <a
              ...
              <Col lg="6" className="d-block d-sm-none">
                <Image
                  className="img-fluid"
                  src={growth}
                  alt="website design company in Belleville"
                />
              </Col>
            </Row>
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6">
                ...
                <p>
                  Ready to transform your Belleville web design into a
                  conversion powerhouse? Our Conversion-Driven Web Design is
                  expertly crafted to do just that. At Infused Agency, we
                  develop stunning Belleville web design solutions that not only
                  ...
                  calls-to-action, our Belleville web design experts create
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={discover}
                    alt="website design discovery Belleville"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={design}
                    alt="website design process Belleville"
                  />
                  <h2>
                    2. <span>Plan</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={realdesign}
                    alt="website design agency Belleville"
                  />
                  <h2>
                    3. <span>Design</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={dev}
                    alt="website development Belleville"
                  />
                  <h2>
                    4. <span>Develop</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={launch}
                    alt="website development launch Belleville"
                  />
                  <h2>
                    5. <span>Launch</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={promote}
                    alt="website design promotion Belleville"
                  />
                  <h2>
                    6. <span>Promote</span>
                  </h2>
          ...
          <Container>
            ...
            <Row className="pd-top-80">
              <Col md="6">
                <h2>
                  Our Belleville website designs are <span>fast</span>,{" "}
            ...
            <Row className="pd-top-40">
              <Col lg="4" className="d-flex">
                <div className="card">
                  <Image src={fast} alt="fast website design Belleville" />
                  <h3>Lightning-Fast Speed</h3>
                  <p>
                    Enjoy unparalleled website speed with Infused Agency’s web
                    design services in Belleville. Our websites are crafted to
              ...
              <Col lg="4" className="d-flex">
                <div className="card">
                  <Image src={build} alt="web designers in Belleville" />
                  <h3>Mobile Performance</h3>
                  <p>
                    Experience a website that performs exceptionally across all
                    devices with Infused Agency’s Belleville web development. We
            ...
            <Row className="pd-top-40">
              <Col md="6">
                <h2>
                  How to <span>increase conversions</span> through Belleville
                  website design.
                </h2>
              </Col>
              <Col md="6">&nbsp;</Col>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={speed}
                    alt="website design speed Belleville"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={ux}
                    alt="website design user experience Belleville"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={opt}
                    alt="website design optimize landing page Belleville"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={testing}
                    alt="website design a/b testing Belleville"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={social}
                    alt="website design social proof Belleville"
                  />
                  <h2>
            ...
            <Row>
              <Col lg="12">
                <div className="card">
                  <img
                    alt="Belleville web design client"
                    width="48"
                    height="48"
