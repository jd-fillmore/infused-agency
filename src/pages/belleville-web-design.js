...
const WebDesign = () => {
  return (
    <>
      <Head>
        <title>Belleville Web Design | Elevate Your Online Presence</title>
        <meta
          name="description"
            ...
            <Row className="pd-top-80 pd-btm-80">
              ...
              <Col lg="6">
                <p>
                  ...
                  Belleville-based businesses. Our team of expert web designers
                  ...
                  competitive Belleville market. Choose Infused Agency for
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6" className="order-1 order-lg-2">
                ...
                <p>
                  ...
                  lead-generation web design and Belleville web design
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6">
                ...
                <p>
                  ...
                  compelling calls-to-action, our Belleville web design experts
