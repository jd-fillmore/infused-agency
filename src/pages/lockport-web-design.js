...
import website from "../img/lockport-web-design.webp";
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Elevate your brand with top-notch Lockport web design services. Affordable, stunning websites that capture attention. Drive growth now!"
        />
        <link
          rel="canonical"
        ...
        <section className="seo-page">
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="Lockport web design company, Lockport web design agency, Lockport web design services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Lockport NY web design services</strong> that our{" "}
                  <strong>Lockport web design company</strong> provides are
                ...
                <ul>
                  ...
                  <li>
                    Improves your Lockport company's reputation and
                    trustworthiness.
                  </li>
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Our Lockport Web Design Clients <span>Get Results</span>
                  </h2>
                </Col>
              </Row>
              <Row>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      By using their web design services, my Lockport company
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with top Lockport web design
                    services?
                  </h3>
          ...
          <section className="seo-services">
            <Container>
              <Row className="pd-top-80 pd-btm-40">
                <Col lg="12 text-center">
                  <h2>
                    Lockport <span>Web Design</span> Services
                  </h2>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    ...
                    key part of our Lockport web design services to help make
                    sure that your customers can find your website. When using
                    our Lockport web design experts and{" "}
                    <Link href="/lockport-seo/">Lockport SEO services</Link>,
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Lockport web designers create websites that bolster your
                ...
                <Col lg="4">
                  ...
                  <p>
                    Every client website we design is custom. Our Lockport web
                    designers will create a modern website design for you,
                    taking into consideration your business goals. We make sure
                    to plug in your vision that factors into our Lockport web
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    We conduct responsive web design as part of our Lockport web
                    design services to help your users navigate your website on
                    any device. Our Lockport web design experts specifically
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our web design company in Lockport uses WordPress for all
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website. With the help of our Lockport web design agency,
                    your e-commerce website can help sell your products online,
                    expanding your reach drastically. Leave it to our Lockport
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Have Our Lockport Web Design Experts Help Today</h3>
                  <p>Click the button below to get your free quote.</p>
                  <a
                    target="_blank"
                    rel="noreferrer"
          ...
          <section className="seo-why pd-top-80">
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Lockport</span> Web
                    Design Agency
                  </h2>
                  <p>
