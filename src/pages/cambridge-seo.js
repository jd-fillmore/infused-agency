...
import website from "../img/cambridge-seo.webp";
...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert SEO services, including lead generation, search engine optimization, and online marketing in Cambridge, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Cambridge SEO 🥇 Best SEO Company in Cambridge, ON | Infused Agency</title>
        <meta
          name="description"
          content="Cambridge SEO Company that will amplify your online visibility. Get more traffic, leads and sales. Get a free quote!"
        />
        <meta property="og:title" content="Cambridge SEO | Infused Agency" />
        <meta name="twitter:title" content="Cambridge SEO | Infused Agency" />
        <link rel="canonical" href="https://infused.agency/cambridge-seo" />
        <script
        ...
        <section className="seo-page">
          <Container>
            <Row>
              <Col md="6">
                <h2>
                  Cambridge SEO crafted to <span>engage</span>,{" "}
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="Cambridge seo company, Cambridge seo services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Cambridge SEO services</strong> that our{" "}
                  <strong>Cambridge SEO company</strong> provides are pretty
                ...
                <ul>
                  ...
                  <li>Improves your Cambridge brand's awareness.</li>
                  <li>It's trackable.</li>
                </ul>
                <p>
                  When you utilize SEO services from our company or use our{" "}
                  <Link href="/cambridge-web-design">Cambridge web design</Link>{" "}
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with our Cambridge SEO Firm?
                  </h3>
            ...
            <Container>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    Infused Agency's Cambridge SEO services conducts specific
                ...
                <Col lg="4">
                  <h5>Link Building</h5>
                  <p>
                    Off of your website, our Cambridge SEO experts utilize
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Cambridge SEO services are conducted by a highly trained
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    ...
                    user experience. This is why our Cambridge SEO agency looks
                ...
                <Col lg="4">
                  <h5>Local SEO</h5>
                  <p>
                    For a more local approach, our Cambridge SEO specialists can
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website, our Cambridge SEO experts are here to help. We'll
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Have Our Cambridge SEO Company Help Today</h3>
                  <p>Click the button below to get your free quote.</p>
                  <a
                    target="_blank"
                    rel="noreferrer"
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Cambridge</span> SEO
                    Agency
                  </h2>
          ...
          <Container>
            <Row className="pd-top-80 pd-btm-60">
              <Col lg="12">
                ...
                <p>
                  ...
                  absolutely you need a Cambridge SEO company to help you with
                  SEO services. It's important that our Cambridge SEO experts
                ...
                <h3>Our Cambridge SEO company is ready to help.</h3>
                <p>
                  If you need our Cambridge SEO company to help your company
            ...
            <Row className="pd-top-40">
              <Col md="6">
                <h2>
                  How to <span>increase conversions</span> using our Cambridge
                  SEO Company.
                </h2>
              </Col>
              <Col md="6">&nbsp;</Col>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={speed}
                      alt="Cambridge seo agency speed"
                    />
                    <h2>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={testing}
                      alt="Cambridge seo company services"
                    />
                    <h2>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={social}
                      alt="search engine optimization Cambridge"
                    />
                    <h2>
            ...
            <Row>
              <Col lg="12">
                ...
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d92761.16370491234!2d-80.41515987830023!3d43.402394470664916!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b89b820e46c19%3A0x5037b28c7231d70!2sCambridge%2C%20ON%2C%20Canada!5e0!3m2!1sen!2sus!4v1722451723446!5m2!1sen!2sus"
                  width="100%"
                  height="450"
                  allowfullscreen=""
                  loading="lazy"
