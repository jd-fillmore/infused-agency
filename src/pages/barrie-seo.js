...
import website from "../img/barrie-seo.webp";
...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert SEO services, including lead generation, search engine optimization, and online marketing in Barrie, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Barrie SEO 🥇 Best SEO Company in Barrie, ON | Infused Agency</title>
        <meta
          name="description"
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="barrie seo company, barrie seo services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                ...
                <ul>
                  ...
                  <li>Improves your Barrie brand's awareness.</li>
            ...
            <Container>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    Infused Agency's Barrie SEO services conducts specific
                ...
                <Col lg="4">
                  <h5>Link Building</h5>
                  <p>
                    Off of your website, our Barrie SEO experts utilize efforts
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Barrie SEO services are conducted by a highly trained
              ...
              <Row className="pd-btm-80">
                ...
                <Col lg="4">
                  <h5>Local SEO</h5>
                  <p>
                    For a more local approach, our Barrie SEO specialists can
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Barrie</span> SEO
                    Agency
                  </h2>
