...
import intro from "../img/digital-marketing-agency-fort-erie.webp";
...
import results from "../img/digital-marketing-agency-fort-erie-results.webp";
import integ from "../img/fort-erie-digital-marketing-agency.webp";
...
const SEO = () => {
  ...
  return (
    <>
      <Head>
        <title>Digital Marketing Agency Fort Erie | Infused Agency</title>
        <meta
          name="description"
          content="Our digital marketing agency Fort Erie team can help your business boost sales, leads and revenue. Get your free consultation today!"
        />
        <link
          rel="canonical"
          href="https://infused.agency/digital-marketing-agency-fort-erie"
        />
      </Head>
      <Nav />
            ...
            <Row>
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h1 className="intro">Digital Marketing Agency Fort Erie</h1>
                  <h2 className="sub">
                    Boost revenue, drive leads and get more sales for your Fort
                    Erie company today!
                  </h2>
                </motion.div>
                <motion.div
            ...
            <Container>
              <Row>
                <Col lg="7">
                  ...
                  >
                    <h2>
                      A Digital Marketing Agency Fort Erie Team That <br />
                      <span>Gets Results</span>
                    </h2>
                    <p>
                      At Infused Agency, our digital marketing agency Fort Erie
                      team helps businesses in Fort Erie grow through digital
                    ...
                    <p>
                      ...
                      Catharines, Fort Erie Falls, Welland, and more. Our goal
                      is to create websites that look good and help attract more
                      customers.
                    </p>
                ...
                <Col lg="5">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={intro}
                      alt="digital marketing agency fort erie"
                    />
                    <br />
                    <br />
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d187141.5800169673!2d-79.17905498481285!3d42.87100386178884!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d33e24e7337d03%3A0x885d5008ef9ad9d1!2sFort%20Erie%2C%20ON!5e0!3m2!1sen!2sca!4v1726015195687!5m2!1sen!2sca"
                      width="100%"
                      height="450"
                      allowfullscreen=""
                      loading="lazy"
              ...
              <Row className="pd-top-80">
                <div className="col-lg-5">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={integ}
                      alt="fort erie digital marketing agency"
                    />
                  </motion.div>
                </div>
                <div className="col-lg-7">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <h2>A Fort Erie Digital Marketing Agency With Integrity</h2>
                    <p>
                      At Infused Agency, our Fort Erie digital marketing agency
              ...
              <div className="row pd-top-80 align-items-center">
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <h3>Our Digital Marketing Agency Fort Erie Team</h3>
                    <p>
                      We have been helping businesses in Fort Erie with our
                    ...
                    <p>
                      ...
                      <strong>understands the Fort Erie area</strong>. We know
                    ...
                    <p>
                      ...
                      people search for services in Fort Erie. This means more
                    ...
                    <p>
                      ...
                      become a trusted digital marketing company for Fort Erie
                    ...
                    <Image
                      className="img-fluid"
                      src={best}
                      alt="digital marketing company fort erie"
                    />
                  </motion.div>
                </div>
                <div className="col-lg-6">
                  ...
                  >
                    <div className="card">
                      <img
                        alt="digital marketing agency fort erie client review"
                        width="48"
                        height="48"
            ...
            <Container>
              <Row className="text-center">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      Our <span>Digital Marketing Services</span> in Fort Erie
                    </h2>
                  </motion.div>
                </Col>
              </Row>
                ...
                <Row className="pd-top-40">
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image
                        src={img1}
                        alt="social media marketing fort erie"
                      />
                      <h3>Social Media Ads Marketing</h3>
                      <p>
                        Our digital marketing agency Fort Erie team offers
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img2} alt="local seo marketing fort erie" />
                      <h3>Local SEO Marketing</h3>
                      <p>
                        Our local SEO marketing service is all about helping
                        your business show up when people in Fort Erie search
                        for services like yours. Our digital marketing agency
                        Fort Erie team makes sure your website is optimized so
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image
                        src={img3}
                        alt="search engine marketing fort erie"
                      />
                      ...
                      <p>
                        ...
                        Our digital marketing agency Fort Erie team uses special
            ...
            <Container>
                ...
                <Col lg="6">
                  ...
                  >
                    <h2 className="pd-btm-40">
                      ...
                      <span>Fort Erie Digital Marketing Agency</span>
                    </h2>
                    <div className="card">
                      <img
                        alt="fort erie digital marketing agency client testimonial"
                        width="48"
                        height="48"
                        src="https://lh3.googleusercontent.com/a/ACg8ocIKt9X9LSKomYMvAkQn_0673Xwg0EBOP-QigGk1AaAVHdVIvA=w48-h48-p-rp-mo-ba3-br100"
                      />
                ...
                <Col lg="6">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={results}
                      alt="fort erie digital marketing agency case study"
                    />
                  </motion.div>
                </Col>
              </Row>
              ...
              <Row className="text-center pd-top-80">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      <span>Frequently Asked</span> Fort Erie Digital Marketing
                      Agency Questions{" "}
                    </h2>
                  </motion.div>
                </Col>
                    ...
                    <Accordion open={open} toggle={toggle}>
                      ...
                      <AccordionItem>
                        <AccordionHeader targetId="2">
                          How can your Fort Erie digital marketing services help
                          my Fort Erie business?
                        </AccordionHeader>
                        <AccordionBody accordionId="2">
                          <h2>
                            How can your Fort Erie digital marketing services
                            help my Fort Erie business?
                          </h2>
                          <p>
          ...
          <Container>
            <Row>
              <Col lg="12">
                ...
                >
                  <h2>
                    Delivering Digital Marketing Services surrounding Fort Erie:
                  </h2>
            ...
            <Row className="text-center">
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2>Need Fort Erie Digital Marketing Services?</h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
                  whileInView={{ opacity: 1, y: 0 }}
