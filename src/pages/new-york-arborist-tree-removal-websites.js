...
import intro from "../img/new-york-arborist-tree-removal-website-design.webp";
...
const OntarioArborist = () => {
  return (
    <>
      <Head>
        <title>
          New York City, Buffalo &amp; NY Arborist Tree Removal Services Website
          Design
        </title>
        <meta
          name="description"
          content="Enhance your New York arborist business with a custom website design for tree removal services. Showcase your expertise and attract more clients. Contact us today for a free quote!"
        />
        <link
          rel="canonical"
          href="https://infused.agency/new-york-arborist-tree-removal-websites"
        />
      </Head>
      <Nav />
        ...
        <section className="niche-inner-hero arborist-hero">
          <Container>
            <Row className="text-center">
              <Col lg="12">
                <h1>
                  Custom Websites for New York Arborists & Tree Removal Services
                </h1>
                <h2>
                  Get the Tree Removal Website Your Arborist Business Needs to
                  Succeed
                </h2>
                <h3>
                  New York City - Buffalo - Rochester - Syracuse - Yonkers and
                  across New York
                </h3>
              ...
              <Row>
                <Col lg="6">
                  <Image
                    className="img-fluid"
                    src={intro}
                    alt="new york city, buffalo arborist tree removal website design services"
                  />
                </Col>
                <Col lg="6">
                  <p>
          ...
          <div className="niche-services pd-top-80">
            <Container>
              <Row className="text-center w-80">
                <Col lg="12">
                  <h2>
                    New York Arborist and Tree Removal Service Website Solutions{" "}
              ...
              <Row className="pd-top-40">
                <Col lg="6" className="d-flex">
                  <div className="card">
                    <Image
                      src={disc}
                      alt="new york arborist &amp; tree removal service discovery call"
                    />
                ...
                <Col lg="6">
                  <div className="card">
                    <Image
                      src={des}
                      alt="new york arborist &amp; tree removal service design"
                    />
                    <h3>Web Design</h3>
                    <ul>
                      <li>
              ...
              <Row>
                <Col lg="6">
                  <div className="card">
                    <Image
                      src={dev}
                      alt="new york arborist &amp; tree removal service web development"
                    />
                ...
                <Col lg="6">
                  <div className="card">
                    <Image
                      src={launch}
                      alt="new york arborist &amp; tree removal website design launch"
                    />
          ...
          <div className="niche-why pd-top-80">
            <Container>
              <Row className="text-center w-80">
                <Col lg="12">
                  <h2>
                    Why Choose <span>Infused Agency</span> As Your New York
              ...
              <Row className="pd-top-40">
                ...
                <Col lg="6">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6011590.08080225!2d-81.05206111595021!3d42.6328091049864!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4ccc4bf0f123a5a9%3A0xddcfc6c1de189567!2sNew%20York%2C%20USA!5e0!3m2!1sen!2sca!4v1720531648315!5m2!1sen!2sca"
                    width="600"
                    height="450"
                    allowfullscreen=""
                    loading="lazy"
