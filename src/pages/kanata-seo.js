...
import website from "../img/kanata-seo.webp";
...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert SEO services, including lead generation, search engine optimization, and online marketing in Kanata, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Kanata SEO 🥇 Best SEO Company in Kanata, ON | Infused Agency</title>
        <meta
          name="description"
          content="Kanata SEO Company that will amplify your online visibility. Get more traffic, leads and sales. Get a free quote!"
        />
        <link rel="canonical" href="https://infused.agency/kanata-seo" />
        <meta property="og:title" content="Kanata SEO | Infused Agency" />
        <meta name="twitter:title" content="Kanata SEO | Infused Agency" />
        <link rel="canonical" href="https://infused.agency/kanata-seo" />
        <script
        ...
        <section className="seo-page">
          <Container>
            <Row>
              <Col md="6">
                <h2>
                  Kanata SEO crafted to <span>engage</span>,{" "}
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="Kanata seo company, Kanata seo services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Kanata SEO services</strong> that our{" "}
                  <strong>Kanata SEO company</strong> provides are pretty
                ...
                <ul>
                  ...
                  <li>Improves your Kanata brand's awareness.</li>
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Ready to grow your business with our Kanata SEO Firm?</h3>
            ...
            <Container>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    Infused Agency's Kanata SEO services conducts specific
                ...
                <Col lg="4">
                  <h5>Link Building</h5>
                  <p>
                    Off of your website, our Kanata SEO experts utilize efforts
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Kanata SEO services are conducted by a highly trained
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    ...
                    user experience. This is why our Kanata SEO agency looks for
                ...
                <Col lg="4">
                  <h5>Local SEO</h5>
                  <p>
                    For a more local approach, our Kanata SEO specialists can
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website, our Kanata SEO experts are here to help. We'll dive
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Have Our Kanata SEO Company Help Today</h3>
                  <p>Click the button below to get your free quote.</p>
                  <a
                    target="_blank"
                    rel="noreferrer"
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Kanata</span> SEO
                    Agency
                  </h2>
          ...
          <Container>
            <Row className="pd-top-80 pd-btm-60">
              <Col lg="12">
                ...
                <p>
                  ...
                  absolutely you need a Kanata SEO company to help you with SEO
                  services. It's important that our Kanata SEO experts help your
                ...
                <h3>Our Kanata SEO company is ready to help.</h3>
                <p>
                  If you need our Kanata SEO company to help your company rise
            ...
            <Row className="pd-top-40">
              <Col md="6">
                <h2>
                  How to <span>increase conversions</span> using our Kanata SEO
                  Company.
                </h2>
              </Col>
              <Col md="6">&nbsp;</Col>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={testing}
                      alt="Kanata seo company services"
                    />
                    <h2>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={social}
                      alt="search engine optimization Kanata"
                    />
                    <h2>
            ...
            <Row>
              <Col lg="12">
                ...
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d179457.65430355578!2d-76.23065389607686!3d45.34829047869396!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4ccdff86df946877%3A0x286ff73092245b34!2sKanata%2C%20Ottawa%2C%20ON!5e0!3m2!1sen!2sca!4v1723511763838!5m2!1sen!2sca"
                  width="100%"
                  height="450"
                  allowfullscreen=""
                  loading="lazy"
