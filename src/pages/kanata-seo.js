...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert Kanata SEO services, including lead generation, development, and online marketing in Kanata, Canada.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Kanata SEO | Best SEO Services in Kanata, ON</title>
        <meta
          name="description"
