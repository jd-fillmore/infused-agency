...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert Grimsby SEO services, including lead generation, development, and online marketing in Grimsby, Canada.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Grimsby SEO | Best SEO Agency in Grimsby, ON</title>
        <meta
          name="description"
