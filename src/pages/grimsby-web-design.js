...
import intro from "../img/web-design-grimsby.webp";
...
import results from "../img/web-design-grimsby-results.webp";
import integ from "../img/grimsby-web-design-agency.webp";
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>
          Web Design Grimsby, ON | Website Developer Grimsby | Award Winning |
          Affordable Grimsby Web Design | Infused Agency | Website Design
          Grimsby, Grimsby Web Design Company, Grimsby Web Designer, Web Design
          Grimsby Ontario
        </title>
        <meta
          name="description"
          content="Our web design Grimsby team makes websites to increase your company's sales. Click here for your free Grimsby web design quote!"
        />
        <link
          rel="canonical"
            ...
            <Row>
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h1 className="intro">Web Design Grimsby</h1>
                  <h2 className="sub">
                    We create Grimsby web designs that attract visitors and turn
                    them into leads, helping your Grimsby business grow.
                  </h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
            ...
            <Container>
              <Row>
                <Col lg="7">
                  ...
                  >
                    <h2>
                      A Web Design Grimsby Agency That <span>Gets Results</span>
                    </h2>
                    <p>
                      At Infused Agency, our web design Grimsby team helps local
                      businesses grow with amazing websites. We create custom
                      Grimsby web design websites to boost your brand and
                    ...
                    <p>
                      We have helped many businesses in the Grimsby area with
              ...
              <Row className="pd-top-80 align-items-center">
                ...
                <div className="col-lg-7">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <h2>A Grimsby Web Design Agency With Integrity</h2>
                    <p>
                      At Infused Agency, our Grimsby web design agency helps all
                    ...
                    <ul>
                      <li>
                        ...
                        Grimsby team makes great websites just for you. Our
              ...
              <div className="row pd-top-80 align-items-center">
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <h3>Our Web Design Grimsby Team</h3>
                    <p>
                      Our web design Grimsby team has been helping businesses in
                      Grimsby with web design for{" "}
                    ...
                    <p>
                      When you choose us,{" "}
                      <strong>
                        you get a team that knows all about Grimsby
                      </strong>
                    ...
                    <p>
                      ...
                      <strong>trusted web design company</strong> for Grimsby
                ...
                <div className="col-lg-6">
                  ...
                  >
                    <div className="card">
                      <img
                        alt="web design agency grimsby client review"
                        width="48"
                        height="48"
            ...
            <Container>
              <Row className="text-center">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      Our Grimsby <span>Web Design Services</span>
                    </h2>
                  </motion.div>
                </Col>
              </Row>
              ...
              >
                <Row className="pd-top-40">
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img1} alt="web design grimsby company" />
                      <h3>Web Design</h3>
                      <p>
                        Our Grimsby web designs make sure that visitors have a
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img2} alt="wordpress web design grimsby" />
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img3} alt="web development grimsby" />
            ...
            <Container>
                ...
                <Col lg="6">
                  ...
                  >
                    <h2 className="pd-btm-40">
                      ...
                      <span>Grimsby Web Design Agency</span>
                    </h2>
                    <div className="card">
                      <img
                        alt="grimsby web design agency client testimonial"
                        width="48"
                        height="48"
                        src="https://lh3.googleusercontent.com/a/ACg8ocIKt9X9LSKomYMvAkQn_0673Xwg0EBOP-QigGk1AaAVHdVIvA=w48-h48-p-rp-mo-ba3-br100"
                      />
                ...
                <Col lg="6">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={results}
                      alt="grimsby web design agency case study"
                    />
                  </motion.div>
                </Col>
              </Row>
              ...
              <Row className="text-center pd-top-80">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      <span>Frequently Asked</span> Grimsby Web Design Agency
                      Questions{" "}
                    </h2>
                  </motion.div>
                </Col>
            ...
            <Row>
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2>Delivering Web Design Services surrounding Grimsby:</h2>
            ...
            <Row className="text-center">
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2>Need Grimsby Web Design Services?</h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
                  whileInView={{ opacity: 1, y: 0 }}
