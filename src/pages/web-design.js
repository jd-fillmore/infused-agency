      ...
      <InnerContent>
        <section className="web-design">
          <Container>
            ...
            <Row className="pd-top-40 d-flex align-items-center">
              ...
              <Col lg="6" className="order-1 order-lg-2">
                ...
                <p>
                  ...
                  growth through exceptional lead-generation design. From the
                  initial concept to the final launch, we craft bespoke digital
                  experiences that drive results. Leveraging cutting-edge
                  platforms like NextJS, WordPress, React, and Shopify, we
                  ensure your website not only looks stunning but also performs
                  optimally. Our expert team combines strategic design with
                  ...
                  Partner with us to transform your online presence and watch
            ...
            <Row className="pd-top-80 d-flex align-items-center">
              <Col lg="6">
                <Image
                  className="img-fluid pd-btm-40"
                  src={convert}
