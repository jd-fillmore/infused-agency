...
import website from "../img/batavia-seo-ny.webp";
  ...
  return (
    <>
      <Head>
        ...
        />
        <link rel="canonical" href="https://infused.agency/batavia-seo" />
      </Head>
      <Nav />
      <InnerHero
        title="Batavia SEO Company"
        description="Infused Agency is an award-winning SEO company in Batavia. We help businesses bring in more revenue through their websites."
        bgImage={bgImage}
      />
      <InnerContent>
        <section className="seo-page">
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="Batavia seo company, Batavia seo agency, Batavia seo services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Batavia SEO services</strong> that our{" "}
                  <strong>Batavia SEO company</strong> provides are pretty
                ...
                <ul>
                  ...
                  <li>Improves your Batavia brand's awareness.</li>
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Our Nearby Batavia SEO Clients <span>Get Results</span>
                  </h2>
                </Col>
              </Row>
              <Row>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      By using their SEO services, my Batavia company went from
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with top Batavia SEO services?
                  </h3>
          ...
          <section className="seo-services">
            <Container>
              <Row className="pd-top-80 pd-btm-40">
                <Col lg="12 text-center">
                  <h2>
                    Batavia <span>SEO</span> Services
                  </h2>
                  <p>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    Infused Agency's SEO company in Batavia conducts specific
                ...
                <Col lg="4">
                  <h5>Link Building</h5>
                  <p>
                    Off of your website, our Batavia SEO exports utilize efforts
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Batavia SEO services are conducted by a highly trained
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    ...
                    user experience. This is why our Batavia SEO agency looks
                ...
                <Col lg="4">
                  <h5>Local SEO</h5>
                  <p>
                    For a more local approach, our Batavia SEO specialists can
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website, our Batavia SEO experts are here to help. We'll
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Have Our Batavia SEO Experts Help Today</h3>
                  <p>Click the button below to get your free quote.</p>
                  <a
                    target="_blank"
                    rel="noreferrer"
          ...
          <section className="seo-why pd-top-80">
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Batavia</span> SEO
                    Agency
                  </h2>
            ...
            <Row className="pd-top-80 pd-btm-60">
              <Col lg="12">
                ...
                <p>
                  ...
                  absolutely you need a Batavia SEO company to help you with SEO
                  services. It's important that our Batavia SEO experts help
                ...
                <h3>Our Batavia SEO company is ready to help.</h3>
                <p>
                  If you need our Batavia SEO company to help your company rise
