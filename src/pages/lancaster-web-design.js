...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Lancaster Web Design | Websites That Drive Results</title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href="https://infused.agency/lancaster-web-design"
        />
      </Head>
      <Nav />
      <InnerHero
            ...
            <Row className="web pd-btm-80">
              ...
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  ...
                  <strong>Lancaster web design company</strong> provides are
                ...
                <ul>
                  ...
                  <li>
                    Improves your Lancaster company's reputation and
                    trustworthiness.
                  </li>
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Our Nearby Lancaster Web Design Clients{" "}
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      By using their web design services, my Lancaster company
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      Lancaster business I do recommend Infused Agency for their
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with top Lancaster web design
                    services?
                  </h3>
            ...
            <Container>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    ...
                    key part of our Lancaster web design services to help make
                    sure that your customers can find your website. When using
                    our Lancaster web design experts and{" "}
                    <Link href="/lancaster-seo/">Lancaster SEO services</Link>,
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Lancaster web designers create websites that bolster
                ...
                <Col lg="4">
                  ...
                  <p>
                    Every client website we design is custom. Our Lancaster web
                    designers will create a modern website design for you,
                    taking into consideration your business goals. We make sure
                    to plug in your vision that factors into our Lancaster web
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    We conduct responsive web design as part of our Lancaster
                    web design services to help your users navigate your website
                    on any device. Our Lancaster web design experts specifically
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our web design company in Lancaster uses WordPress for all
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website. With the help of our Lancaster web design agency,
                    your e-commerce website can help sell your products online,
                    expanding your reach drastically. Leave it to our Lancaster
          ...
          <section className="seo-why pd-top-80">
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Lancaster</span> Web
                    Design Agency
                  </h2>
                  <p>
              ...
              <Row>
                <Col lg="6">
                  <p>
                    Since 2013 we've been able to help countless local Lancaster
