...
const SEO = ({ latestPosts }) => {
  return (
    <>
      <Head>
        <title>Welland SEO & Digital Marketing Agency | Infused Agency</title>
        <meta
          name="description"
          content="Increase your Welland business’s visibility with expert SEO and digital marketing services. We deliver customized campaigns designed to grow local leads and sales."
        />
        <link rel="canonical" href="https://infused.agency/welland" />
      </Head>
      <Nav />
      <InnerHeroCities
