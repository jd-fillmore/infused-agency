...
import website from "../img/east-aurora-web-design-ny.webp";
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>East Aurora Web Design | NY Website Developer</title>
        <meta
          name="description"
          content="Elevate your brand with top-notch East Aurora web design services. Affordable, stunning websites that capture attention. Drive growth now!"
        />
        <link
          rel="canonical"
      ...
      <Nav />
      <InnerHero
        title="East Aurora Web Design Company"
        description="Infused Agency is an award-winning web design company that serves East Aurora. We help businesses bring in more revenue through their websites."
        bgImage={bgImage}
      />
      <InnerContent>
        <section className="seo-page">
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="East Aurora web design company, East Aurora web design agency, East Aurora web design services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>East Aurora web design services</strong> that our{" "}
                  <strong>East Aurora web design company</strong> provides are
                ...
                <ul>
                  ...
                  <li>
                    Improves your East Aurora company's reputation and
                    trustworthiness.
                  </li>
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Our Nearby East Aurora Web Design Clients{" "}
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      By using their web design services, my East Aurora company
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      East Aurora business I do recommend Infused Agency for
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with top East Aurora web design
                    services?
                  </h3>
          ...
          <section className="seo-services">
            <Container>
              <Row className="pd-top-80 pd-btm-40">
                <Col lg="12 text-center">
                  <h2>
                    East Aurora <span>Web Design</span> Services
                  </h2>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    ...
                    key part of our East Aurora web design services to help make
                    sure that your customers can find your website. When using
                    our East Aurora web design experts and{" "}
                    <Link href="/east-aurora-seo/">
                      East Aurora SEO services
                    </Link>
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our East Aurora web designers create websites that bolster
                ...
                <Col lg="4">
                  ...
                  <p>
                    Every client website we design is custom. Our East Aurora
                    web designers will create a modern website design for you,
                    taking into consideration your business goals. We make sure
                    to plug in your vision that factors into our East Aurora web
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    We conduct responsive web design as part of our East Aurora
                    web design services to help your users navigate your website
                    on any device. Our East Aurora web design experts
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our web design company in East Aurora uses WordPress for all
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website. With the help of our East Aurora web design agency,
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Have Our East Aurora Web Design Experts Help Today</h3>
                  <p>Click the button below to get your free quote.</p>
                  <a
                    target="_blank"
                    rel="noreferrer"
