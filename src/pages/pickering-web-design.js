...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert web design services, including lead generation, development, and online marketing in Pickering, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const WebDesign = () => {
  return (
    <>
      <Head>
        <title>Pickering Web Design | Responsive Sites for Local Brands</title>
        <meta
          name="description"
          ...
          <Container>
            ...
            <Row className="pd-top-80 pd-btm-80">
              ...
              <Col lg="6">
                <p>
                  ...
                  Pickering-based businesses. Our team of expert web designers
                  ...
                  competitive Pickering market. Choose Infused Agency for
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6" className="order-1 order-lg-2">
                ...
                <p>
                  ...
                  in Pickering through our outstanding lead-generation web
                  design services. From initial concept to final launch, our
                  Pickering web design experts create custom digital experiences
                  that yield remarkable results. Utilizing advanced web design
                  platforms such as NextJS, WordPress, React, and Shopify, we
                  ensure your Pickering-based website is not only visually
                  ...
                  lead-generation web design and Pickering web design solutions,
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6">
                ...
                <p>
                  Ready to transform your Pickering web design into a conversion
                  powerhouse? Our Conversion-Driven Web Design is expertly
                  crafted to do just that. At Infused Agency, we develop
                  stunning Pickering web design solutions that not only
                  ...
                  compelling calls-to-action, our Pickering web design experts
