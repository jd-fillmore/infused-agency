...
const WebDesign = () => {
  return (
    <>
      <Head>
        <title>Collingwood Web Design | Stunning Sites for Local Brands</title>
        <meta
          name="description"
            ...
            <Row className="pd-top-80 pd-btm-80">
              ...
              <Col lg="6">
                <p>
                  ...
                  Collingwood-based businesses. Our team of expert web designers
                  ...
                  competitive Collingwood market. Choose Infused Agency for
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6" className="order-1 order-lg-2">
                ...
                <p>
                  ...
                  lead-generation web design and Collingwood web design
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6">
                ...
                <p>
                  ...
                  develop stunning Collingwood web design solutions that not
                  ...
                  compelling calls-to-action, our Collingwood web design experts
              ...
              <Col lg="4" className="d-flex">
                <div className="card">
                  ...
                  <p>
                    ...
                    devices with Infused Agency’s Collingwood web development.
