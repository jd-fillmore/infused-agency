...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert Niagara-on-the-Lake SEO services, including lead generation, development, and online marketing in Niagara-on-the-Lake, Canada.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>
          Niagara-on-the-Lake SEO | Best SEO Agency in Niagara-on-the-Lake, ON
        </title>
        <meta
          name="description"
