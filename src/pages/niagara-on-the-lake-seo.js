...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert SEO services, including lead generation, search engine optimization, and online marketing in Niagara-on-the-Lake, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>
          Niagara-on-the-Lake SEO 🥇 Best SEO Company in Niagara-on-the-Lake, ON | Infused Agency
        </title>
        <meta
          name="description"
          content="Niagara-on-the-Lake SEO Company that will amplify your online visibility. Get more traffic, leads and sales. Get a free quote!"
        />
        <meta
          property="og:title"
          content="Niagara-on-the-Lake SEO | Infused Agency"
        />
        <meta
          name="twitter:title"
          content="Niagara-on-the-Lake SEO | Infused Agency"
      ...
      <CityHeroSEO
        ...
        alt="Niagara-on-the-Lake SEO Agency"
        ...
        <section className="seo-page">
          <Container>
            <Row>
              <Col md="6">
                <h2>
                  Niagara-on-the-Lake SEO crafted to <span>engage</span>,{" "}
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="Niagara-on-the-Lake seo company, Niagara-on-the-Lake seo services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Niagara-on-the-Lake SEO services</strong> that our{" "}
                  <strong>Niagara-on-the-Lake SEO company</strong> provides are
                ...
                <div className="col-lg-4">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={kdImg}
                      alt="seo services in Niagara-on-the-Lake"
                    />
                    <h3>KD Flowers</h3>
                    <p className="testimonial">
                ...
                <div className="col-lg-4 d-flex">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={cassImg}
                      alt="Niagara-on-the-Lake seo agency firm"
                    />
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with our Niagara-on-the-Lake SEO
                    Firm?
                  </h3>
          ...
          <section className="seo-services">
            <Container>
              <Row className="pd-top-80 pd-btm-40">
                <Col lg="12 text-center">
                  <h2>Niagara-on-the-Lake SEO Services</h2>
                  <p>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    Infused Agency's Niagara-on-the-Lake SEO services conducts
                ...
                <Col lg="4">
                  <h5>Link Building</h5>
                  <p>
                    Off of your website, our Niagara-on-the-Lake SEO experts
                    utilize efforts to build links to your website, to help your
                    site rise in search rankings. When other websites link back
                    to your own, you can be seen as authoratative and rank for
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Niagara-on-the-Lake SEO services are conducted by a
                    highly trained group of marketers, which includes content
                    writers. At Infused, you can take advantage of our content
                    writing skills to create content that attracts highly
                    qualified leads. We help mix keywords and your brand voice
                    together, to help bring in more leads to your website.
                  </p>
                </Col>
              </Row>
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    ...
                    user experience. This is why our Niagara-on-the-Lake SEO
                    agency looks for and fixes these issues for you. We conduct
                    on-page SEO to help bolster your online presence, amplify
                ...
                <Col lg="4">
                  <h5>Local SEO</h5>
                  <p>
                    For a more local approach, our Niagara-on-the-Lake SEO
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website, our Niagara-on-the-Lake SEO experts are here to
                    help. We'll dive into your website by conducting a site-wide
                    audit to check for problems related to website speed,
                    content and optimization. Our team will fix these issues,
                    helping your website get back on the right track.
                  </p>
                </Col>
              </Row>
            </Container>
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Have Our Niagara-on-the-Lake SEO Company Help Today</h3>
                  <p>Click the button below to get your free quote.</p>
                  <a
                    target="_blank"
                    rel="noreferrer"
              ...
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    ...
                    <span>Niagara-on-the-Lake</span> SEO Agency
                  </h2>
          ...
          <Container>
            <Row className="pd-top-80 pd-btm-60">
              <Col lg="12">
                ...
                <p>
                  ...
                  absolutely you need a Niagara-on-the-Lake SEO company to help
                  you with SEO services. It's important that our
                  Niagara-on-the-Lake SEO experts help your website rank where
                ...
                <p>
                  If you need our Niagara-on-the-Lake SEO company to help your
            ...
            <Row className="pd-top-40">
              <Col md="6">
                <h2>
                  How to <span>increase conversions</span> using our
                  Niagara-on-the-Lake SEO Company.
                </h2>
              </Col>
              <Col md="6">&nbsp;</Col>
            </Row>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={speed}
                      alt="Niagara-on-the-Lake seo agency speed"
                    />
                    <h2>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={ux}
                      alt="Niagara-on-the-Lake seo firm"
                    />
                    <h2>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={opt}
                      alt="seo in Niagara-on-the-Lake"
                    />
                    <h2>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={testing}
                      alt="Niagara-on-the-Lake seo company services"
                    />
                    <h2>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={social}
                      alt="search engine optimization Niagara-on-the-Lake"
                    />
                    <h2>
            ...
            <Row>
              <Col lg="12">
                <div className="card">
                  <img
                    alt="Niagara-on-the-Lake seo client"
                    width="48"
                    height="48"
                ...
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d371704.09595907707!2d-79.74864688677553!3d43.29461483244895!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d35f14d91702b1%3A0x760151547d11a2c0!2sNiagara-on-the-Lake%2C%20ON!5e0!3m2!1sen!2sca!4v1723568709440!5m2!1sen!2sca"
                  width="100%"
                  height="450"
                  allowfullscreen=""
                  loading="lazy"
