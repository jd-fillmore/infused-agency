...
const WebDesign = () => {
  return (
    <>
      <Head>
        <title>Sault St. Marie Web Design 🥇 Best Web Design Company in Sault St. Marie, ON | Infused Agency</title>
        <meta
          name="description"
        ...
        <section className="web-design">
            ...
            <Row className="pd-top-80 pd-btm-80">
              ...
              <Col lg="6">
                <p>
                  ...
                  Sault Ste Marie-based businesses. Our team of expert web designers is
                  ...
                  Sault Ste Marie market. Choose Infused Agency for cutting-edge web
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6" className="order-1 order-lg-2">
                ...
                <p>
                  ...
                  in Sault Ste Marie through our outstanding lead-generation web design
                  services. From initial concept to final launch, our Sault Ste Marie
                  ...
                  Sault Ste Marie-based website is not only visually appealing but also
                  ...
                  Sault Ste Marie web design solutions, and watch your online presence
                  flourish.
                </p>
                <a
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6">
                ...
                <p>
                  ...
                  develop stunning Sault Ste Marie web design solutions that not only
                  ...
                  calls-to-action, our Sault Ste Marie web design experts create
          ...
          <Container>
            ...
            <Row className="pd-top-40">
              <Col lg="4" className="d-flex">
                <div className="card">
                  ...
                  <p>
                    ...
                    design services in Sault Ste Marie. Our websites are crafted to
              ...
              <Col lg="4" className="d-flex">
                <div className="card">
                  ...
                  <p>
                    ...
                    devices with Infused Agency’s Sault Ste Marie web development. We
              ...
              <Col lg="4">
                <div className="card">
                  <Image src={grow} alt="web design company in Sault Ste Marie" />
            ...
            <Row className="pd-top-40">
              <Col md="6">
                <h2>
                  How to <span>increase conversions</span> through Sault Ste Marie
                  website design.
                </h2>
              </Col>
              <Col md="6">&nbsp;</Col>
