...
import intro from "../img/sault-ste-marie-web-design.webp";
...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert web design services, including lead generation, development, and online marketing in Sault St. Marie, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
        addressLocality: "Sault St. Marie",
        addressRegion: "ON",
...
const WebDesign = () => {
  return (
    <>
      <Head>
        <title>
          Sault Ste. Marie Web Design | Northern Ontario's Web Experts
        </title>
        <meta
          name="description"
          content="Top Sault Ste Marie web design by Infused Agency. Expert website design services to enhance your online presence. Get a free quote today!"
        />
        <meta
          property="og:title"
          content="Web Design Sault Ste Marie | Infused Agency"
        />
        <meta
          name="twitter:title"
          content="Web Design Sault Ste Marie | Infused Agency"
        ...
        <link
          rel="canonical"
          href="https://infused.agency/sault-ste-marie-web-design"
        />
        <script
      ...
      <CityHero
        ...
        alt="web design Sault Ste Marie"
        ...
        <section className="web-design">
          <Container>
            ...
            <Row>
              <Col md="6">
                <h2>
                  Sault Ste Marie website design crafted to <span>engage</span>,{" "}
            ...
            <Row className="pd-top-80 pd-btm-80">
              <Col lg="6">
                <Image
                  className="img-fluid"
                  src={intro}
                  alt="web design Sault Ste Marie conversion"
                />
              </Col>
              <Col lg="6">
                <p>
                  At Infused Agency, our Sault Ste Marie web design services are
                  ...
                  Sault Ste Marie-based businesses. Our team of expert web
                  designers is dedicated to creating high-performing sites that
                  not only attract visitors but also foster meaningful
                  interactions and drive conversions. Whether you’re seeking a
                  brand-new web design or a strategic update, our goal is to
                  elevate your online presence and help your business thrive in
                  the competitive Sault Ste Marie market. Choose Infused Agency
                  for cutting-edge web design solutions that truly deliver
                  results
                </p>
              </Col>
            </Row>
            <div className="niche-services pd-top-40">
              <Row className="text-center w-80">
                <Col lg="12">
                  <h2>
                    Our Sault Ste Marie Web Design Company Will
                    <br />
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6" className="order-1 order-lg-2">
                ...
                <p>
                  ...
                  in Sault Ste Marie through our outstanding lead-generation web
                  design services. From initial concept to final launch, our
                  Sault Ste Marie web design experts create custom digital
                  experiences that yield remarkable results. Utilizing advanced
                  web design platforms such as NextJS, WordPress, React, and
                  Shopify, we ensure your Sault Ste Marie-based website is not
                  only visually appealing but also highly functional. Our team
                  blends strategic web design with cutting-edge technology to
                  develop high-converting websites that engage your audience and
                  drive your business forward. Choose Infused Agency for
                  superior lead-generation web design and Sault Ste Marie web
                  design solutions, and watch your online presence flourish.
                </p>
                <a
              ...
              <Col lg="6" className="d-block d-sm-none">
                <Image
                  className="img-fluid"
                  src={growth}
                  alt="website design company in Sault Ste Marie"
                />
              </Col>
            </Row>
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              <Col lg="6" className="d-block d-lg-none">
                <Image
                  ...
                  src={funnel}
                  alt="Sault Ste Marie web designers"
                />
              </Col>
              <Col lg="6">
                <h2>
              ...
              <Col lg="6" className="d-none d-lg-block">
                <Image
                  className="img-fluid"
                  src={funnel}
                  alt="website design Sault Ste Marie"
                />
              </Col>
            </Row>
            <Row className="pd-top-120 d-flex align-items-center">
              <Col lg="6">
                <Image
                  className="img-fluid pd-btm-40"
                  src={convert}
                  alt="web designers Sault Ste Marie"
                />
              </Col>
              <Col lg="6">
                <h2>
                ...
                <p>
                  Ready to transform your Sault Ste Marie web design into a
                  conversion powerhouse? Our Conversion-Driven Web Design is
                  expertly crafted to do just that. At Infused Agency, we
                  develop stunning Sault Ste Marie web design solutions that not
                  ...
                  compelling calls-to-action, our Sault Ste Marie web design
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={discover}
                    alt="website design discovery Sault Ste Marie"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={design}
                    alt="website design process Sault Ste Marie"
                  />
                  <h2>
                    2. <span>Plan</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={realdesign}
                    alt="website design agency Sault Ste Marie"
                  />
                  <h2>
                    3. <span>Design</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={dev}
                    alt="website development Sault Ste Marie"
                  />
                  <h2>
                    4. <span>Develop</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={launch}
                    alt="website development launch Sault Ste Marie"
                  />
                  <h2>
                    5. <span>Launch</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={promote}
                    alt="website design promotion Sault Ste Marie"
                  />
                  <h2>
                    6. <span>Promote</span>
                  </h2>
          ...
          <Container>
            ...
            <Row className="pd-top-80">
              <Col md="6">
                <h2>
                  Our Sault Ste Marie website designs are <span>fast</span>,{" "}
            ...
            <Row className="pd-top-40">
              <Col lg="4" className="d-flex">
                <div className="card">
                  <Image src={fast} alt="fast website design Sault Ste Marie" />
                  <h3>Lightning-Fast Speed</h3>
                  <p>
                    Enjoy unparalleled website speed with Infused Agency’s web
                    design services in Sault Ste Marie. Our websites are crafted
                    to load almost instantly, providing a smooth user experience
              ...
              <Col lg="4" className="d-flex">
                <div className="card">
                  <Image src={build} alt="web designers in Sault Ste Marie" />
                  <h3>Mobile Performance</h3>
                  <p>
                    Experience a website that performs exceptionally across all
                    devices with Infused Agency’s Sault Ste Marie web
                    development. We ensure your site is perfectly optimized for
                    mobile, delivering a seamless and engaging experience that
            ...
            <Row className="pd-top-40">
              <Col md="6">
                <h2>
                  How to <span>increase conversions</span> through Sault Ste
                  Marie website design.
                </h2>
              </Col>
              <Col md="6">&nbsp;</Col>
            </Row>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={speed}
                    alt="website design speed Sault Ste Marie"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={ux}
                    alt="website design user experience Sault Ste Marie"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={opt}
                    alt="website design optimize landing page Sault Ste Marie"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={testing}
                    alt="website design a/b testing Sault Ste Marie"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={social}
                    alt="website design social proof Sault Ste Marie"
                  />
                  <h2>
            ...
            <Row>
              <Col lg="12">
                <div className="card">
                  <img
                    alt="Sault Ste Marie web design client"
                    width="48"
                    height="48"
