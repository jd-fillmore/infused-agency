...
import intro from "../img/windsor-web-design.webp";
...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert web design services, including lead generation, development, and online marketing in Windsor, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const WebDesign = () => {
  return (
    <>
      <Head>
        <title>Windsor Web Design 🥇 Best Web Design Company in Windsor, ON | Infused Agency</title>
        <meta
          name="description"
          content="Top Windsor web design by Infused Agency. Expert website design services to enhance your online presence. Get a free quote today!"
        />
        <meta
          property="og:title"
          content="Web Design Windsor | Infused Agency"
        />
        <meta
          name="twitter:title"
          content="Web Design Windsor | Infused Agency"
        ...
        <link
          rel="canonical"
          href="https://infused.agency/windsor-web-design"
        />
        <script
        ...
        <section className="web-design">
          <Container>
            ...
            <Row>
              <Col md="6">
                <h2>
                  Windsor website design crafted to <span>engage</span>,{" "}
            ...
            <Row className="pd-top-80 pd-btm-80">
              <Col lg="6">
                <Image
                  className="img-fluid"
                  src={intro}
                  alt="web design Windsor conversion"
                />
              </Col>
              <Col lg="6">
                <p>
                  At Infused Agency, our Windsor web design services are
                  ...
                  Windsor-based businesses. Our team of expert web designers is
                  ...
                  Windsor market. Choose Infused Agency for cutting-edge web
            ...
            <div className="niche-services pd-top-40">
              <Row className="text-center w-80">
                <Col lg="12">
                  <h2>
                    Our Windsor Web Design Company Will
                    <br />
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6" className="order-1 order-lg-2">
                ...
                <p>
                  ...
                  in Windsor through our outstanding lead-generation web design
                  services. From initial concept to final launch, our Windsor
                  ...
                  Windsor-based website is not only visually appealing but also
                  ...
                  Windsor web design solutions, and watch your online presence
                  flourish.
                </p>
                <a
              ...
              <Col lg="6" className="d-block d-sm-none">
                <Image
                  className="img-fluid"
                  src={growth}
                  alt="website design company in Windsor"
                />
              </Col>
            </Row>
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6">
                ...
                <p>
                  ...
                  calls-to-action, our Windsor web design experts create
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={discover}
                    alt="website design discovery Windsor"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={design}
                    alt="website design process Windsor"
                  />
                  <h2>
                    2. <span>Plan</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={realdesign}
                    alt="website design agency Windsor"
                  />
                  <h2>
                    3. <span>Design</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={dev}
                    alt="website development Windsor"
                  />
                  <h2>
                    4. <span>Develop</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={launch}
                    alt="website development launch Windsor"
                  />
                  <h2>
                    5. <span>Launch</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={promote}
                    alt="website design promotion Windsor"
                  />
                  <h2>
                    6. <span>Promote</span>
                  </h2>
          ...
          <Container>
            ...
            <Row className="pd-top-80">
              <Col md="6">
                <h2>
                  Our Windsor website designs are <span>fast</span>,{" "}
            ...
            <Row className="pd-top-40">
              <Col lg="4" className="d-flex">
                <div className="card">
                  <Image src={fast} alt="fast website design Windsor" />
                  <h3>Lightning-Fast Speed</h3>
                  <p>
                    Enjoy unparalleled website speed with Infused Agency’s web
                    design services in Windsor. Our websites are crafted to
              ...
              <Col lg="4" className="d-flex">
                <div className="card">
                  <Image src={build} alt="web designers in Windsor" />
                  <h3>Mobile Performance</h3>
                  <p>
                    Experience a website that performs exceptionally across all
                    devices with Infused Agency’s Windsor web development. We
            ...
            <Row className="pd-top-40">
              <Col md="6">
                <h2>
                  How to <span>increase conversions</span> through Windsor
                  website design.
                </h2>
              </Col>
              <Col md="6">&nbsp;</Col>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={speed}
                    alt="website design speed Windsor"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={ux}
                    alt="website design user experience Windsor"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={opt}
                    alt="website design optimize landing page Windsor"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={testing}
                    alt="website design a/b testing Windsor"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={social}
                    alt="website design social proof Windsor"
                  />
                  <h2>
