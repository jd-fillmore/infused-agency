...
import website from "../img/north-bay-seo.webp";
...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert SEO services, including lead generation, search engine optimization, and online marketing in North Bay, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>North Bay SEO 🥇 Best SEO Company in North Bay, ON | Infused Agency</title>
        <meta
          name="description"
          content="North Bay SEO Company that will amplify your online visibility. Get more traffic, leads and sales. Get a free quote!"
        />
        <link rel="canonical" href="https://infused.agency/north-bay-seo" />
        <meta property="og:title" content="North Bay SEO | Infused Agency" />
        <meta name="twitter:title" content="North Bay SEO | Infused Agency" />
        <link rel="canonical" href="https://infused.agency/north-bay-seo" />
        <script
        ...
        <section className="seo-page">
          <Container>
            <Row>
              <Col md="6">
                <h2>
                  North Bay SEO crafted to <span>engage</span>,{" "}
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="North Bay seo company, North Bay seo services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>North Bay SEO services</strong> that our{" "}
                  <strong>North Bay SEO company</strong> provides are pretty
                ...
                <ul>
                  ...
                  <li>Improves your North Bay brand's awareness.</li>
                  <li>It's trackable.</li>
                </ul>
                <p>
                  When you utilize SEO services from our company or use our{" "}
                  <Link href="/north-bay-web-design">North Bay web design</Link>{" "}
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with our North Bay SEO Firm?
                  </h3>
            ...
            <Container>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    Infused Agency's North Bay SEO services conducts specific
                ...
                <Col lg="4">
                  <h5>Link Building</h5>
                  <p>
                    Off of your website, our North Bay SEO experts utilize
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our North Bay SEO services are conducted by a highly trained
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    ...
                    user experience. This is why our North Bay SEO agency looks
                ...
                <Col lg="4">
                  <h5>Local SEO</h5>
                  <p>
                    For a more local approach, our North Bay SEO specialists can
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website, our North Bay SEO experts are here to help. We'll
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Have Our North Bay SEO Company Help Today</h3>
                  <p>Click the button below to get your free quote.</p>
                  <a
                    target="_blank"
                    rel="noreferrer"
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>North Bay</span> SEO
                    Agency
                  </h2>
          ...
          <Container>
            <Row className="pd-top-80 pd-btm-60">
              <Col lg="12">
                ...
                <p>
                  ...
                  absolutely you need a North Bay SEO company to help you with
                  SEO services. It's important that our North Bay SEO experts
                ...
                <h3>Our North Bay SEO company is ready to help.</h3>
                <p>
                  If you need our North Bay SEO company to help your company
            ...
            <Row className="pd-top-40">
              <Col md="6">
                <h2>
                  How to <span>increase conversions</span> using our North Bay
                  SEO Company.
                </h2>
              </Col>
              <Col md="6">&nbsp;</Col>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={speed}
                      alt="North Bay seo agency speed"
                    />
                    <h2>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={testing}
                      alt="North Bay seo company services"
                    />
                    <h2>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={social}
                      alt="search engine optimization North Bay"
                    />
                    <h2>
            ...
            <Row>
              <Col lg="12">
                ...
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d45881.58593130398!2d-79.50240536164176!3d44.05033578784969!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882ad20bf0ae014f%3A0xcb39bf730072dc8f!2sNorth Bay%2C%20ON!5e0!3m2!1sen!2sca!4v1723512118786!5m2!1sen!2sca"
                  width="100%"
                  height="450"
                  allowfullscreen=""
                  loading="lazy"
