...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert North Bay SEO services, including lead generation, development, and online marketing in North Bay, Canada.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>North Bay SEO | Best SEO Services in North Bay, ON</title>
        <meta
          name="description"
