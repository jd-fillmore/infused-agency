...
import website from "../img/caledonia-web-design.webp";
...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert web design services, including lead generation, development, and online marketing in Caledonia, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>
          Caledonia Web Design 🥇 Best Web Design Company in Caledonia, ON | Infused Agency
        </title>
        <meta
          name="description"
          content="Elevate your brand with top-notch Caledonia web design services. Affordable, stunning websites that capture attention. Drive growth now!"
        />
        <link
          rel="canonical"
      ...
      <Nav />
      <InnerHero
        title="Caledonia Web Design Company"
        description="Infused Agency is an award-winning web design company that serves Caledonia. We help businesses bring in more revenue through their websites."
        bgImage={bgImage}
      />
      <InnerContent>
        <section className="seo-page">
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="Caledonia web design company, Caledonia web design agency, Caledonia web design services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Caledonia web design services</strong> that our{" "}
                  <strong>Caledonia web design company</strong> provides are
                ...
                <ul>
                  ...
                  <li>
                    Improves your Caledonia company's reputation and
                    trustworthiness.
                  </li>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      By using their web design services, my Caledonia company
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with top Caledonia web design
                    services?
                  </h3>
          ...
          <section className="seo-services">
            <Container>
              <Row className="pd-top-80 pd-btm-40">
                <Col lg="12 text-center">
                  <h2>
                    Caledonia <span>Web Design</span> Services
                  </h2>
              ...
              <Row>
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Caledonia web designers create websites that bolster
                ...
                <Col lg="4">
                  ...
                  <p>
                    Every client website we design is custom. Our Caledonia web
                    designers will create a modern website design for you,
                    taking into consideration your business goals. We make sure
                    to plug in your vision that factors into our Caledonia web
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    We conduct responsive web design as part of our Caledonia
                    web design services to help your users navigate your website
                    on any device. Our Caledonia web design experts specifically
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our web design company in Caledonia uses WordPress for all
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website. With the help of our Caledonia web design agency,
                    your e-commerce website can help sell your products online,
                    expanding your reach drastically. Leave it to our Caledonia
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Have Our Caledonia Web Design Experts Help Today</h3>
                  <p>Click the button below to get your free quote.</p>
                  <a
                    target="_blank"
                    rel="noreferrer"
          ...
          <section className="seo-why pd-top-80">
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Caledonia</span> Web
                    Design Agency
                  </h2>
                  <p>
