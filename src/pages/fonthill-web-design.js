...
import intro from "../img/web-design-fonthill.webp";
...
import results from "../img/web-design-fonthill-results.webp";
import integ from "../img/fonthill-web-design-agency.webp";
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>
          Web Design Fonthill | Website Developer Fonthill | Award Winning |
          Affordable Fonthill Web Design | Infused Agency | Website Design
          Fonthill, Fonthill Web Design Company, Fonthill Web Designer, Web
          Design Fonthill Ontario
        </title>
        <meta
          name="description"
          content="Our web design Fonthill team makes websites to increase your company's sales. Click here for your free Fonthill web design quote!"
        />
        <link
          rel="canonical"
            ...
            <Row>
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h1 className="intro">Web Design Fonthill</h1>
                  <h2 className="sub">
                    We create Fonthill web designs that attract visitors and
                    turn them into leads, helping your Fonthill business grow.
                  </h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
            ...
            <Container>
              <Row>
                <Col lg="7">
                  ...
                  >
                    <h2>
                      A Web Design Fonthill Agency That{" "}
                      <span>Gets Results</span>
                    </h2>
                    <p>
                      At Infused Agency, our web design Fonthill team helps
                      local businesses grow with amazing websites. We create
                      custom Fonthill web design websites to boost your brand
                    ...
                    <p>
                      We have helped many businesses in the Fonthill area with
              ...
              <Row className="pd-top-80 align-items-center">
                ...
                <div className="col-lg-7">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <h2>A Fonthill Web Design Agency With Integrity</h2>
                    <p>
                      At Infused Agency, our Fonthill web design agency helps
                    ...
                    <ul>
                      <li>
                        ...
                        Fonthill team makes great websites just for you. Our
              ...
              <div className="row pd-top-80 align-items-center">
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <h3>Our Web Design Fonthill Team</h3>
                    <p>
                      Our web design Fonthill team has been helping businesses
                      in Fonthill with web design for{" "}
                    ...
                    <p>
                      When you choose us,{" "}
                      <strong>
                        you get a team that knows all about Fonthill
                      </strong>
                    ...
                    <p>
                      ...
                      <strong>trusted web design company</strong> for Fonthill
                    ...
                    <Image
                      className="img-fluid"
                      src={best}
                      alt="web design company fonthill-lincoln"
                    />
                  </motion.div>
                </div>
                <div className="col-lg-6">
                  ...
                  >
                    <div className="card">
                      <img
                        alt="web design agency fonthill client review"
                        width="48"
                        height="48"
            ...
            <Container>
              <Row className="text-center">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      Our Fonthill <span>Web Design Services</span>
                    </h2>
                  </motion.div>
                </Col>
              </Row>
              ...
              >
                <Row className="pd-top-40">
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img1} alt="web design fonthill company" />
                      <h3>Web Design</h3>
                      <p>
                        Our Fonthill web designs make sure that visitors have a
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img2} alt="wordpress web design fonthill" />
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img3} alt="web development fonthill" />
                ...
                <Col lg="6">
                  ...
                  >
                    <h2 className="pd-btm-40">
                      ...
                      <span>Fonthill Web Design Agency</span>
                    </h2>
                    <div className="card">
                      <img
                        alt="fonthill web design agency client testimonial"
                        width="48"
                        height="48"
                        src="https://lh3.googleusercontent.com/a/ACg8ocIKt9X9LSKomYMvAkQn_0673Xwg0EBOP-QigGk1AaAVHdVIvA=w48-h48-p-rp-mo-ba3-br100"
                      />
                ...
                <Col lg="6">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={results}
                      alt="fonthill web design agency case study"
                    />
                  </motion.div>
                </Col>
              </Row>
            ...
            <Row>
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2>Delivering Web Design Services surrounding Fonthill:</h2>
            ...
            <Row className="text-center">
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2>Need Fonthill Web Design Services?</h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
                  whileInView={{ opacity: 1, y: 0 }}
