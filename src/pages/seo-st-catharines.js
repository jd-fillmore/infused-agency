        ...
        <section className="seo-page">
          <Container>
            <Row className="web pd-btm-80">
              ...
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>St. Catharines SEO services</strong> that our <strong>St. Catharines SEO company</strong>{" "}
              ...
              <Row>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <h4>KD Flowers</h4>
                    <p>
                      "Infused Agency drastically improved my online presence. By using their SEO services, my St.
                      Catharines company went from not ranking at all to the first page of Google for tons of keywords."
                    </p>
                    <ul>
                      <li>
                        <strong>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      SEO for your St. Catharines business I do recommend Infused Agency for their services. JD keep up
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Ready to grow your business with top St. Catharines SEO services?</h3>
            ...
            <Container>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    Infused Agency's SEO company in St. Catharines conducts specific keyword research that covers
                ...
                <Col lg="4">
                  <h5>Link Building</h5>
                  <p>
                    Off of your website, our St. Catharines SEO exports utilize efforts to build links to your website,
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our St. Catharines SEO services are conducted by a highly trained group of marketers, which includes
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    ...
                    give your users a poor user experience. This is why our St. Catharines SEO agency looks for and
                ...
                <Col lg="4">
                  <h5>Local SEO</h5>
                  <p>
                    For a more local approach, our St. Catharines SEO specialists can leverage the power of local SEO.
                    We help local customers find your website in local search engine rankings. We do this by employing
                    on and off page search engine optimization best practices, to help raise your local website in
                    Google's rankings.
                  </p>
                </Col>
                <Col lg="4">
                  <h5>Technical SEO</h5>
                  <p>
                    If you find out about some technical mishaps on your website, our St. Catharines SEO experts are
                    here to help. We'll dive into your website by conducting a site-wide audit to check for problems
          ...
          <section className="seo-why pd-top-80">
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>St. Catharines</span> SEO Agency
                  </h2>
              ...
              <Row>
                <Col lg="6">
                  <p>
                    ...
                    <Link href="/digital-marketing-St. Catharines">digital marketing</Link>, search engine optimization
                    (SEO) , <Link href="/wordpress-developer-St. Catharines">WordPress development</Link> and{" "}
                    <Link href="/ecommerce-web-design-St. Catharines">e-commerce website development</Link>.
                  </p>
                  <p>
          ...
          <Container>
            <Row className="pd-top-80 pd-btm-60">
              <Col lg="12">
                ...
                <h3>Do I need SEO?</h3>
                <p>
                  Does your business depend on attracting new customers? Then absolutely you need a St. Catharines SEO
                  company to help you with SEO services. It's important that our St. Catharines SEO experts help your
                ...
                <p>
                  If you need our St. Catharines SEO company to help your company rise in Google with our expert SEO
          ...
          <About
            ...
            intro={[
              ...
              <a href="https://en.wikipedia.org/wiki/St._Catharines">St. Catharines</a>,
