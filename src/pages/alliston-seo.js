...
import website from "../img/alliston-seo.webp";
  ...
  return (
    <>
      <Head>
        ...
        />
        <link rel="canonical" href="https://infused.agency/alliston-seo" />
      </Head>
      <Nav />
      <InnerHero
        title="Alliston SEO Company"
        description="Infused Agency is an award-winning SEO company in Alliston. We help businesses bring in more revenue through their websites."
        bgImage={bgImage}
      />
      <InnerContent>
        <section className="seo-page">
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="Alliston seo company, Alliston seo agency, Alliston seo services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Alliston SEO services</strong> that our <strong>Alliston SEO company</strong> provides are
                ...
                <ul>
                  ...
                  <li>Improves your Alliston brand's awareness.</li>
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Our Alliston SEO Clients <span>Get Results</span>
                  </h2>
                </Col>
              </Row>
              <Row>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <h4>KD Flowers</h4>
                    <p>
                      "Infused Agency drastically improved my online presence. By using their SEO services, my Alliston
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      SEO for your Alliston business I do recommend Infused Agency for their services. JD keep up the
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Ready to grow your business with top Alliston SEO services?</h3>
          ...
          <section className="seo-services">
            <Container>
              <Row className="pd-top-80 pd-btm-40">
                <Col lg="12 text-center">
                  <h2>
                    Alliston <span>SEO</span> Services
                  </h2>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    Infused Agency's SEO company in Alliston conducts specific keyword research that covers specifically
                ...
                <Col lg="4">
                  <h5>Link Building</h5>
                  <p>
                    Off of your website, our Alliston SEO exports utilize efforts to build links to your website, to
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Alliston SEO services are conducted by a highly trained group of marketers, which includes
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    ...
                    give your users a poor user experience. This is why our Alliston SEO agency looks for and fixes
                ...
                <Col lg="4">
                  <h5>Local SEO</h5>
                  <p>
                    For a more local approach, our Alliston SEO specialists can leverage the power of local SEO. We help
                ...
                <Col lg="4">
                  <h5>Technical SEO</h5>
                  <p>
                    If you find out about some technical mishaps on your website, our Alliston SEO experts are here to
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Have Our Alliston SEO Experts Help Today</h3>
                  <p>Click the button below to get your free quote.</p>
                  <a target="_blank" rel="noreferrer" href="https://calendly.com/infused-agency/project-discovery/">
                    <button>Get Free Quote</button>
                  </a>
          ...
          <section className="seo-why pd-top-80">
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Alliston</span> SEO Agency
                  </h2>
              ...
              <Row>
                <Col lg="6">
                  <p>
                    Since 2013 we've been able to help countless local Alliston businesses (and beyond!) with their{" "}
          ...
          <Container>
            <Row className="pd-top-80 pd-btm-60">
              <Col lg="12">
                ...
                <h3>Do I need SEO?</h3>
                <p>
                  Does your business depend on attracting new customers? Then absolutely you need a Alliston SEO company
                  to help you with SEO services. It's important that our Alliston SEO experts help your website rank
                ...
                <h3>Our Alliston SEO company is ready to help.</h3>
                <p>
                  If you need our Alliston SEO company to help your company rise in Google with our expert SEO services,
