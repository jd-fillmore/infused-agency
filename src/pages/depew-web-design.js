...
import website from "../img/depew-web-design-ny.webp";
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Depew Web Design | NY Website Developer</title>
        <meta
          name="description"
          content="Elevate your brand with top-notch Depew web design services. Affordable, stunning websites that capture attention. Drive growth now!"
        />
        <link rel="canonical" href="https://infused.agency/depew-web-design" />
      </Head>
      <Nav />
      <InnerHero
        title="Depew Web Design Company"
        description="Infused Agency is an award-winning web design company that serves Depew. We help businesses bring in more revenue through their websites."
        bgImage={bgImage}
      />
      <InnerContent>
        <section className="seo-page">
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="Depew web design company, Depew web design agency, Depew web design services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Depew web design services</strong> that our{" "}
                  <strong>Depew web design company</strong> provides are pretty
                ...
                <ul>
                  ...
                  <li>
                    Improves your Depew company's reputation and
                    trustworthiness.
                  </li>
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Our Nearby Depew Web Design Clients <span>Get Results</span>
                  </h2>
                </Col>
              </Row>
              <Row>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      By using their web design services, my Depew company went
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      Depew business I do recommend Infused Agency for their
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with top Depew web design
                    services?
                  </h3>
          ...
          <section className="seo-services">
            <Container>
              <Row className="pd-top-80 pd-btm-40">
                <Col lg="12 text-center">
                  <h2>
                    Depew <span>Web Design</span> Services
                  </h2>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    ...
                    key part of our Depew web design services to help make sure
                    that your customers can find your website. When using our
                    Depew web design experts and{" "}
                    <Link href="/depew-seo/">Depew SEO services</Link>, your
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Depew web designers create websites that bolster your
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    We conduct responsive web design as part of our Depew web
                    design services to help your users navigate your website on
                    any device. Our Depew web design experts specifically
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our web design company in Depew uses WordPress for all
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Have Our Depew Web Design Experts Help Today</h3>
                  <p>Click the button below to get your free quote.</p>
                  <a
                    target="_blank"
                    rel="noreferrer"
          ...
          <section className="seo-why pd-top-80">
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Depew</span> Web
                    Design Agency
                  </h2>
                  <p>
