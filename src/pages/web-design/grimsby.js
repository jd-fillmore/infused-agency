...
import hero from "../../img/web-design-grimsby.webp";
...
const SEO = ({ latestPosts }) => {
  return (
    <>
      <Head>
        <title>Web Design Grimsby</title>
        <meta
          name="description"
          content="Expert web design and development services in Grimsby. Boost your online presence with a custom website tailored to your business needs."
        />
        <link
          rel="canonical"
          href="https://infused.agency/web-design/grimsby"
        />
      </Head>
      <Nav />
      <InnerHeroCities
        title="Web Design Grimsby"
        subTitle="We're Infused Agency, a Grimsby web design company."
        image={hero}
        ...
        <div className="container">
          <div className="row text-center">
            <div className="col-lg-12">
              <h2>
                Grimsby Web Design Services That <span>Get Great Results</span>
              </h2>
            </div>
          </div>
          <Row>
        ...
        <div className="container">
          <div className="row pd-top-120">
            <div className="col-lg-7">
              <h2>Why Choose Infused As Your Grimsby Web Design Agency?</h2>
              <p>
                It's simple. Our Grimsby{" "}
                <a
                ...
                <Link href="/seo/grimsby">SEO</Link>. We understand what works
                best for companies in Grimsby, crafting websites that are not
              ...
              <Image
                className="img-fluid"
                src={best}
                alt="Grimsby web design company"
              />
            </div>
        ...
        <div className="container">
          <div className="row pd-btm-40">
            <div className="col-lg-12 text-center">
              <h2>Grimsby Web Design Services</h2>
            </div>
          </div>
        </div>
        <div className="container">
            ...
            <div className="col-lg-4 d-flex">
              <div className="card">
                ...
                <p>
                  ...
                  plan for your Grimsby web design.
                </p>
              </div>
            </div>
            <div className="col-lg-4 d-flex">
      ...
      <section className="home-faq">
        <Container>
          <Row className="text-center pd-btm-40">
            <Col lg="12">
              <h2>FAQs for Local Grimsby Web Design Clients</h2>
            </Col>
          </Row>
          ...
          <Row>
            <Col lg="12">
              ...
              <h3>How much does web design in Grimsby cost?</h3>
              <p>
              ...
              <h3>
                What are the benefits of a well-designed website for my Grimsby
                business?
              </h3>
              <p>
