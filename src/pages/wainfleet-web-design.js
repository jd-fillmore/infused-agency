...
import intro from "../img/web-design-wainfleet.webp";
...
import results from "../img/web-design-wainfleet-results.webp";
import integ from "../img/wainfleet-web-design-agency.webp";
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>
          Web Design Wainfleet | Website Developer Wainfleet | Award Winning |
          Affordable Wainfleet Web Design | Infused Agency | Website Design
          Wainfleet, Wainfleet Web Design Company, Wainfleet Web Designer, Web
          Design Wainfleet Ontario
        </title>
        <meta
          name="description"
          content="Our web design Wainfleet team makes websites to increase your company's sales. Click here for your free Wainfleet web design quote!"
        />
        <link
          rel="canonical"
            ...
            <Row>
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h1 className="intro">Web Design Wainfleet</h1>
                  <h2 className="sub">
                    We create Wainfleet web designs that attract visitors and
                    turn them into leads, helping your Wainfleet business grow.
                  </h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
            ...
            <Container>
              <Row>
                <Col lg="7">
                  ...
                  >
                    <h2>
                      A Web Design Wainfleet Agency That{" "}
                      <span>Gets Results</span>
                    </h2>
                    <p>
                      At Infused Agency, our web design Wainfleet team helps
                      local businesses grow with amazing websites. We create
                      custom Wainfleet web design websites to boost your brand
                    ...
                    <ol>
                      ...
                      <li>
                        ...
                        website look great, rank higher on Google , and turn
                        visitors into customers. Our goal is to create websites
                        that help you get more sales.
                      </li>
                    </ol>
                    <p>
                      We have helped many businesses in the Wainfleet area with
              ...
              <Row className="pd-top-80 align-items-center">
                ...
                <div className="col-lg-7">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <h2>A Wainfleet Web Design Agency With Integrity</h2>
                    <p>
                      At Infused Agency, our Wainfleet web design agency helps
                    ...
                    <ul>
                      <li>
                        ...
                        Wainfleet team makes great websites just for you. Our
              ...
              <div className="row pd-top-80 align-items-center">
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <h3>Our Web Design Wainfleet Team</h3>
                    <p>
                      Our web design Wainfleet team has been helping businesses
                      in Wainfleet with web design for{" "}
                    ...
                    <p>
                      When you choose us,{" "}
                      <strong>
                        you get a team that knows all about Wainfleet
                      </strong>
                    ...
                    <p>
                      ...
                      <strong>trusted web design company</strong> for Wainfleet
                    ...
                    <Image
                      className="img-fluid"
                      src={best}
                      alt="web design company wainfleet"
                    />
                  </motion.div>
                </div>
                <div className="col-lg-6">
                  ...
                  >
                    <div className="card">
                      <img
                        alt="web design agency wainfleet client review"
                        width="48"
                        height="48"
            ...
            <Container>
              <Row className="text-center">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      Our Wainfleet <span>Web Design Services</span>
                    </h2>
                  </motion.div>
                </Col>
              </Row>
              ...
              >
                <Row className="pd-top-40">
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img1} alt="web design wainfleet company" />
                      <h3>Web Design</h3>
                      <p>
                        Our Wainfleet web designs make sure that visitors have a
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img2} alt="wordpress web design wainfleet" />
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image src={img3} alt="web development wainfleet" />
            ...
            <Container>
                ...
                <Col lg="6">
                  ...
                  >
                    <h2 className="pd-btm-40">
                      ...
                      <span>Wainfleet Web Design Agency</span>
                    </h2>
                    <div className="card">
                      <img
                        alt="wainfleet web design agency client testimonial"
                        width="48"
                        height="48"
                        src="https://lh3.googleusercontent.com/a/ACg8ocIKt9X9LSKomYMvAkQn_0673Xwg0EBOP-QigGk1AaAVHdVIvA=w48-h48-p-rp-mo-ba3-br100"
                      />
                ...
                <Col lg="6">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={results}
                      alt="wainfleet web design agency case study"
                    />
                  </motion.div>
                </Col>
              </Row>
              ...
              <Row className="text-center pd-top-80">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      <span>Frequently Asked</span> Wainfleet Web Design Agency
                      Questions{" "}
                    </h2>
                  </motion.div>
                </Col>
            ...
            <Row>
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2>Delivering Web Design Services surrounding Wainfleet:</h2>
            ...
            <Row className="text-center">
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2>Need Wainfleet Web Design Services?</h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
                  whileInView={{ opacity: 1, y: 0 }}
