...
import intro from "../img/digital-marketing-agency-st-catharines.webp";
...
import results from "../img/digital-marketing-agency-st-catharines-results.webp";
import integ from "../img/st-catharines-digital-marketing-agency.webp";
...
const SEO = () => {
  ...
  return (
    <>
      <Head>
        <title>Digital Marketing Agency St. Catharines | Infused Agency</title>
        <meta
          name="description"
          content="Our digital marketing agency St. Catharines team can help your business boost sales, leads and revenue. Get your free consultation today!"
        />
        <link
          rel="canonical"
          href="https://infused.agency/digital-marketing-agency-st-catharines"
        />
      </Head>
      <Nav />
          ...
          <Container>
            <Row>
              <Col lg="12">
                ...
                >
                  <h1 className="intro">
                    Digital Marketing Agency St. Catharines
                  </h1>
                  <h2 className="sub">
                    Boost revenue, drive leads and get more sales for your St.
                    Catharines company today!
                  </h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
            ...
            <Container>
              <Row>
                <Col lg="7">
                  ...
                  >
                    <h2>
                      A Digital Marketing Agency St. Catharines Team That <br />
                      <span>Gets Results</span>
                    </h2>
                    <p>
                      At Infused Agency, our digital marketing agency St.
                      Catharines team helps businesses in St. Catharines grow
                    ...
                    <p>
                      ...
                      Catharines, St. Catharines Falls, Welland, and more. Our
                ...
                <Col lg="5">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={intro}
                      alt="digital marketing agency st. catharines"
                    />
                    <br />
                    <br />
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d93098.81173163535!2d-79.3316002151586!3d43.181421061656025!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d35054bb6a5a4b%3A0x37563636c082837!2sSt.%20Catharines%2C%20ON!5e0!3m2!1sen!2sca!4v1726060005243!5m2!1sen!2sca"
                      width="100%"
                      height="450"
                      allowfullscreen=""
                      loading="lazy"
              ...
              <Row className="pd-top-80">
                <div className="col-lg-5">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={integ}
                      alt="st. catharines digital marketing agency"
                    />
                  </motion.div>
                </div>
                <div className="col-lg-7">
                  ...
                  >
                    <h2>
                      A St. Catharines Digital Marketing Agency With Integrity
                    </h2>
                    <p>
                      At Infused Agency, our St. Catharines digital marketing
                      ...
                      business is. Our modern St. Catharines digital marketing
                      strategies are designed to get you more customers and are
                      easy to understand.
                    </p>

                    <p>
                      We focus on three key areas to help your St. Catharines
                      business succeed:
                    </p>
                    <ul>
                      <li>
                        <strong>SEO and Local SEO</strong>: We make sure your
                        St. Catharines website shows up in search results so
              ...
              <div className="row pd-top-80 align-items-center">
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <h3>Our Digital Marketing Agency St. Catharines Team</h3>
                    <p>
                      We have been helping businesses in St. Catharines with our
                    ...
                    <p>
                      ...
                      <strong>understands the St. Catharines area</strong>. We
                    ...
                    <p>
                      ...
                      people search for services in St. Catharines. This means
                    ...
                    <p>
                      ...
                      become a trusted digital marketing company for St.
                      Catharines businesses. If you're looking to grow your
                      business online, we're here to help!
                    </p>
                    <Image
                      className="img-fluid"
                      src={best}
                      alt="digital marketing company st. catharines"
                    />
                  </motion.div>
                </div>
                <div className="col-lg-6">
                  ...
                  >
                    <div className="card">
                      <img
                        alt="digital marketing agency st. catharines client review"
                        width="48"
                        height="48"
            ...
            <Container>
              <Row className="text-center">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      Our <span>Digital Marketing Services</span> in St.
                      Catharines
                    </h2>
                  </motion.div>
                </Col>
                ...
                <Row className="pd-top-40">
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image
                        src={img1}
                        alt="social media marketing st. catharines"
                      />
                      <h3>Social Media Ads Marketing</h3>
                      <p>
                        Our digital marketing agency St. Catharines team offers
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image
                        src={img2}
                        alt="local seo marketing st. catharines"
                      />
                      <h3>Local SEO Marketing</h3>
                      <p>
                        Our local SEO marketing service is all about helping
                        your business show up when people in St. Catharines
                        search for services like yours. Our digital marketing
                        agency St. Catharines team makes sure your website is
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image
                        src={img3}
                        alt="search engine marketing st. catharines"
                      />
                      ...
                      <p>
                        ...
                        Our digital marketing agency St. Catharines team uses
            ...
            <Container>
                ...
                <Col lg="6">
                  ...
                  >
                    <h2 className="pd-btm-40">
                      ...
                      <span>St. Catharines Digital Marketing Agency</span>
                    </h2>
                    <div className="card">
                      <img
                        alt="st. catharines digital marketing agency client testimonial"
                        width="48"
                        height="48"
                        src="https://lh3.googleusercontent.com/a/ACg8ocIKt9X9LSKomYMvAkQn_0673Xwg0EBOP-QigGk1AaAVHdVIvA=w48-h48-p-rp-mo-ba3-br100"
                      />
                ...
                <Col lg="6">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={results}
                      alt="st. catharines digital marketing agency case study"
                    />
                  </motion.div>
                </Col>
              </Row>
              ...
              <Row className="text-center pd-top-80">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      <span>Frequently Asked</span> St. Catharines Digital
                    ...
                    <Accordion open={open} toggle={toggle}>
                      ...
                      <AccordionItem>
                        <AccordionHeader targetId="2">
                          How can your St. Catharines digital marketing services
                          help my St. Catharines business?
                        </AccordionHeader>
                        <AccordionBody accordionId="2">
                          <h2>
                            How can your St. Catharines digital marketing
                            services help my St. Catharines business?
                          </h2>
                          <p>
          ...
          <Container>
            <Row>
              <Col lg="12">
                ...
                >
                  <h2>
                    Delivering Digital Marketing Services surrounding St.
                    Catharines:
                  </h2>
            ...
            <Row className="text-center">
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2>Need St. Catharines Digital Marketing Services?</h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
                  whileInView={{ opacity: 1, y: 0 }}
