...
const Home = () => {
  return (
    <>
      <Helmet>
        <title>Niagara Web Design | Infused Agency</title>
        <meta
          name="description"
          content="Niagara Web Design company with unmatched quality and superior websites. Our web designers will elevate your brand. Get a free quote today!"
        />
