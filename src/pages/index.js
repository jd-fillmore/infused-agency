...
const Home = () => {
  return (
    <>
      <Head>
        <title>Infused / Niagara Web Design and Development Agency</title>
        <meta
          name="description"
            ...
            <div className="row">
              <div className="col-lg-7">
                ...
                <p>
                  ...
                  Niagara-on-the-Lake and other areas with our website-making skills. Our websites are easy to use and
                  help businesses grow and make more money. We also have experts who make sure your website can be
