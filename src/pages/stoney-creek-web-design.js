...
import website from "../img/stoney-creek-web-design.webp";
  ...
  return (
    <>
      ...
      <InnerHero
        ...
        description="Infused Agency is an award-winning web design company that serves Stoney Creek. We help businesses bring in more revenue through their websites."
        bgImage={bgImage}
      />
      <InnerContent>
        <section className="seo-page">
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="Stoney Creek web design company, Stoney Creek web design agency, Stoney Creek web design services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Stoney Creek web design services</strong> that our{" "}
                  <strong>Stoney Creek web design company</strong> provides are
                ...
                <ul>
                  ...
                  <li>
                    Improves your Stoney Creek company's reputation and
                    trustworthiness.
                  </li>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      By using their web design services, my Stoney Creek
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      Stoney Creek business I do recommend Infused Agency for
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with top Stoney Creek web design
                    services?
                  </h3>
          ...
          <section className="seo-services">
            <Container>
              <Row className="pd-top-80 pd-btm-40">
                <Col lg="12 text-center">
                  <h2>
                    Stoney Creek <span>Web Design</span> Services
                  </h2>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    ...
                    <Link href="/Stoney Creek-seo-company/">
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Stoney Creek web designers create websites that bolster
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    We conduct responsive web design as part of our Stoney Creek
                    web design services to help your users navigate your website
                    on any device. Our Stoney Creek web design experts
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our web design company in Stoney Creek uses WordPress for
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Have Our Stoney Creek Web Design Experts Help Today</h3>
                  <p>Click the button below to get your free quote.</p>
                  <a
                    target="_blank"
                    rel="noreferrer"
          ...
          <Container>
            <Row className="pd-top-80 pd-btm-60">
              <Col lg="12">
                ...
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d23370.59753975929!2d-79.39260922032638!3d42.92928135329211!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d334b202bdff43%3A0xf2051a5eb1cbc6c8!2sStoney Creek%2C%20ON!5e0!3m2!1sen!2sca!4v1708799264570!5m2!1sen!2sca"
                  width="600"
                  height="450"
                  allowfullscreen=""
                  loading="lazy"
