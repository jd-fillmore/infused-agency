...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert SEO services, including lead generation, search engine optimization, and online marketing in Caledonia, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Caledonia SEO 🥇 Best SEO Company in Caledonia, ON | Infused Agency</title>
        <meta
          name="description"
