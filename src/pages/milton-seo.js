...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert Milton SEO services, including lead generation, development, and online marketing in Milton, Canada.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Milton SEO | Best SEO Services in Milton, ON</title>
        <meta
          name="description"
