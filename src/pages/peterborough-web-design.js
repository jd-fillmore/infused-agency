...
import intro from "../img/peterborough-web-design.webp";
...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert web design services, including lead generation, development, and online marketing in Peterborough, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const WebDesign = () => {
  return (
    <>
      <Head>
        <title>
          Peterborough Web Design | Crafting Digital Success Stories
        </title>
        <meta
          name="description"
          content="Top Peterborough web design by Infused Agency. Expert website design services to enhance your online presence. Get a free quote today!"
        />
        <meta
          property="og:title"
          content="Web Design Peterborough | Infused Agency"
        />
        <meta
          name="twitter:title"
          content="Web Design Peterborough | Infused Agency"
        ...
        <link
          rel="canonical"
          href="https://infused.agency/peterborough-web-design"
        />
        <script
        ...
        <section className="web-design">
          <Container>
            ...
            <Row>
              <Col md="6">
                <h2>
                  Peterborough website design crafted to <span>engage</span>,{" "}
            ...
            <Row className="pd-top-80 pd-btm-80">
              <Col lg="6">
                <Image
                  className="img-fluid"
                  src={intro}
                  alt="web design Peterborough conversion"
                />
              </Col>
              <Col lg="6">
                <p>
                  At Infused Agency, our Peterborough web design services are
                  ...
                  Peterborough-based businesses. Our team of expert web
                  ...
                  the competitive Peterborough market. Choose Infused Agency for
            ...
            <div className="niche-services pd-top-40">
              <Row className="text-center w-80">
                <Col lg="12">
                  <h2>
                    Our Peterborough Web Design Company Will
                    <br />
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              ...
              <Col lg="6" className="order-1 order-lg-2">
                ...
                <p>
                  ...
                  in Peterborough through our outstanding lead-generation web
                  design services. From initial concept to final launch, our
                  Peterborough web design experts create custom digital
                  experiences that yield remarkable results. Utilizing advanced
                  web design platforms such as NextJS, WordPress, React, and
                  Shopify, we ensure your Peterborough-based website is not only
                  ...
                  lead-generation web design and Peterborough web design
              ...
              <Col lg="6" className="d-block d-sm-none">
                <Image
                  className="img-fluid"
                  src={growth}
                  alt="website design company in Peterborough"
                />
              </Col>
            </Row>
            ...
            <Row className="pd-top-120 d-flex align-items-center">
              <Col lg="6" className="d-block d-lg-none">
                <Image
                  ...
                  src={funnel}
                  alt="Peterborough web designers"
                />
              </Col>
              <Col lg="6">
                <h2>
              ...
              <Col lg="6" className="d-none d-lg-block">
                <Image
                  className="img-fluid"
                  src={funnel}
                  alt="website design Peterborough"
                />
              </Col>
            </Row>
            <Row className="pd-top-120 d-flex align-items-center">
              <Col lg="6">
                <Image
                  className="img-fluid pd-btm-40"
                  src={convert}
                  alt="web designers Peterborough"
                />
              </Col>
              <Col lg="6">
                <h2>
                ...
                <p>
                  Ready to transform your Peterborough web design into a
                  conversion powerhouse? Our Conversion-Driven Web Design is
                  expertly crafted to do just that. At Infused Agency, we
                  develop stunning Peterborough web design solutions that not
                  ...
                  compelling calls-to-action, our Peterborough web design
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={discover}
                    alt="website design discovery Peterborough"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={design}
                    alt="website design process Peterborough"
                  />
                  <h2>
                    2. <span>Plan</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={realdesign}
                    alt="website design agency Peterborough"
                  />
                  <h2>
                    3. <span>Design</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={dev}
                    alt="website development Peterborough"
                  />
                  <h2>
                    4. <span>Develop</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={launch}
                    alt="website development launch Peterborough"
                  />
                  <h2>
                    5. <span>Launch</span>
                  </h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={promote}
                    alt="website design promotion Peterborough"
                  />
                  <h2>
                    6. <span>Promote</span>
                  </h2>
          ...
          <Container>
            ...
            <Row className="pd-top-80">
              <Col md="6">
                <h2>
                  Our Peterborough website designs are <span>fast</span>,{" "}
            ...
            <Row className="pd-top-40">
              <Col lg="4" className="d-flex">
                <div className="card">
                  <Image src={fast} alt="fast website design Peterborough" />
                  <h3>Lightning-Fast Speed</h3>
                  <p>
                    Enjoy unparalleled website speed with Infused Agency’s web
                    design services in Peterborough. Our websites are crafted to
              ...
              <Col lg="4" className="d-flex">
                <div className="card">
                  <Image src={build} alt="web designers in Peterborough" />
                  <h3>Mobile Performance</h3>
                  <p>
                    Experience a website that performs exceptionally across all
                    devices with Infused Agency’s Peterborough web development.
            ...
            <Row className="pd-top-40">
              <Col md="6">
                <h2>
                  How to <span>increase conversions</span> through Peterborough
                  website design.
                </h2>
              </Col>
              <Col md="6">&nbsp;</Col>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={speed}
                    alt="website design speed Peterborough"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={ux}
                    alt="website design user experience Peterborough"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={opt}
                    alt="website design optimize landing page Peterborough"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={testing}
                    alt="website design a/b testing Peterborough"
                  />
                  <h2>
              ...
              <Col lg="12">
                <div className="card">
                  <Image
                    className="img-fluid"
                    src={social}
                    alt="website design social proof Peterborough"
                  />
                  <h2>
            ...
            <Row>
              <Col lg="12">
                <div className="card">
                  <img
                    alt="Peterborough web design client"
                    width="48"
                    height="48"
