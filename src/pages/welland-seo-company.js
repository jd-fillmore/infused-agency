...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert Welland SEO services, including lead generation, development, and online marketing in Welland, Canada.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Welland SEO | Best SEO Agency in Welland, ON</title>
        <meta
          name="description"
