...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert Collingwood SEO services, including lead generation, development, and online marketing in Collingwood, Canada.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Collingwood SEO | ON Search Engine Optimization</title>
        <meta
          name="description"
