...
import website from "../img/collingwood-seo.webp";
...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert SEO services, including lead generation, search engine optimization, and online marketing in Collingwood, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>
          Collingwood SEO | Blue Mountain's Digital Marketing Experts
        </title>
        <meta
          name="description"
          content="Collingwood SEO Company that will amplify your online visibility. Get more traffic, leads and sales. Get a free quote!"
        />
        <meta property="og:title" content="Collingwood SEO | Infused Agency" />
        <meta name="twitter:title" content="Collingwood SEO | Infused Agency" />
        <link rel="canonical" href="https://infused.agency/collingwood-seo" />
        <script
        ...
        <section className="seo-page">
          <Container>
            <Row>
              <Col md="6">
                <h2>
                  Collingwood SEO crafted to <span>engage</span>,{" "}
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="Collingwood seo company, Collingwood seo services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Collingwood SEO services</strong> that our{" "}
                  <strong>Collingwood SEO company</strong> provides are pretty
                ...
                <ul>
                  ...
                  <li>Improves your Collingwood brand's awareness.</li>
                  <li>It's trackable.</li>
                </ul>
                <p>
                  When you utilize SEO services from our company or use our{" "}
                  <Link href="/">web design</Link> services and end up ranking
                  on the first of Google, it's a great way to increase your
                  company's revenue.
                </p>
              </Col>
            </Row>
                ...
                <div className="col-lg-4">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={kdImg}
                      alt="seo services in Collingwood"
                    />
                    <h3>KD Flowers</h3>
                    <p className="testimonial">
                ...
                <div className="col-lg-4 d-flex">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={cassImg}
                      alt="Collingwood seo agency firm"
                    />
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with our Collingwood SEO Firm?
                  </h3>
          ...
          <section className="seo-services">
            <Container>
              <Row className="pd-top-80 pd-btm-40">
                <Col lg="12 text-center">
                  <h2>Collingwood SEO Services</h2>
                  <p>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    Infused Agency's Collingwood SEO services conducts specific
                ...
                <Col lg="4">
                  <h5>Link Building</h5>
                  <p>
                    Off of your website, our Collingwood SEO experts utilize
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Collingwood SEO services are conducted by a highly
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    ...
                    user experience. This is why our Collingwood SEO agency
                ...
                <Col lg="4">
                  <h5>Local SEO</h5>
                  <p>
                    For a more local approach, our Collingwood SEO specialists
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website, our Collingwood SEO experts are here to help. We'll
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Have Our Collingwood SEO Company Help Today</h3>
                  <p>Click the button below to get your free quote.</p>
                  <a
                    target="_blank"
                    rel="noreferrer"
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Collingwood</span>{" "}
                    SEO Agency
                  </h2>
          ...
          <Container>
            <Row className="pd-top-80 pd-btm-60">
              <Col lg="12">
                ...
                <p>
                  ...
                  absolutely you need a Collingwood SEO company to help you with
                  SEO services. It's important that our Collingwood SEO experts
                ...
                <h3>Our Collingwood SEO company is ready to help.</h3>
                <p>
                  If you need our Collingwood SEO company to help your company
            ...
            <Row className="pd-top-40">
              <Col md="6">
                <h2>
                  How to <span>increase conversions</span> using our Collingwood
                  SEO Company.
                </h2>
              </Col>
              <Col md="6">&nbsp;</Col>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={speed}
                      alt="Collingwood seo agency speed"
                    />
                    <h2>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={testing}
                      alt="Collingwood seo company services"
                    />
                    <h2>
                ...
                <Col lg="12">
                  <div className="card">
                    <Image
                      className="img-fluid"
                      src={social}
                      alt="search engine optimization Collingwood"
                    />
                    <h2>
            ...
            <Row>
              <Col lg="12">
                ...
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d91058.9678163429!2d-80.29996188240027!3d44.50301099013166!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882a7bdbea583ae5%3A0xd9be61e8338ba720!2sCollingwood%2C%20ON%2C%20Canada!5e0!3m2!1sen!2sus!4v1722451843398!5m2!1sen!2sus"
                  width="100%"
                  height="450"
                  allowfullscreen=""
                  loading="lazy"
