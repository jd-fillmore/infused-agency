...
import intro from "../img/digital-marketing-agency-crystal-beach.webp";
...
import results from "../img/digital-marketing-agency-crystal-beach-results.webp";
import integ from "../img/crystal-beach-digital-marketing-agency.webp";
...
const SEO = () => {
  ...
  return (
    <>
      <Head>
        <title>Digital Marketing Agency Crystal Beach | Infused Agency</title>
        <meta
          name="description"
          content="Our digital marketing agency Crystal Beach team can help your business boost sales, leads and revenue. Get your free consultation today!"
        />
        <meta name="geo.region" content="CA-ON" />
        <meta name="geo.placename" content="Crystal Beach" />
        <meta name="geo.position" content="43.0896;-79.0849" />
        <meta name="ICBM" content="43.0896, -79.0849" />
        <link
          rel="canonical"
          href="https://infused.agency/digital-marketing-agency-crystal-beach"
        />
      </Head>
      <Nav />
          ...
          <Container>
            <Row>
              <Col lg="12">
                ...
                >
                  <h1 className="intro">
                    Digital Marketing Agency Crystal Beach
                  </h1>
                  <h2 className="sub">
                    Boost revenue, drive leads and get more sales for your
                    Crystal Beach company today!
                  </h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
            ...
            <Container>
              <Row>
                <Col lg="7">
                  ...
                  >
                    <h2>
                      A Digital Marketing Agency Crystal Beach Team That <br />
                      <span>Gets Results</span>
                    </h2>
                    <p>
                      At Infused Agency, our digital marketing agency Crystal
                      Beach team helps businesses in Crystal Beach grow through
                      digital marketing. Our team creates custom plans to
                      improve your brand using the latest marketing strategies.
                    </p>
                    <ol>
                      <li>
                    ...
                    <p>
                      ...
                      Catharines, Crystal Beach Falls, Welland, and more. Our
                ...
                <Col lg="5">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={intro}
                      alt="digital marketing agency crystal beach"
                    />
                    <br />
                    <br />
                    <iframe
              ...
              <Row className="pd-top-80">
                <div className="col-lg-5">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={integ}
                      alt="crystal beach digital marketing agency"
                    />
                  </motion.div>
                </div>
                <div className="col-lg-7">
                  ...
                  >
                    <h2>
                      A Crystal Beach Digital Marketing Agency With Integrity
                    </h2>
                    <p>
                      At Infused Agency, our Crystal Beach digital marketing
                      ...
                      business is. Our modern Crystal Beach digital marketing
              ...
              <div className="row pd-top-80 align-items-center">
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <h3>Our Digital Marketing Agency Crystal Beach Team</h3>
                    <p>
                      We have been helping businesses in Crystal Beach with our
                    ...
                    <p>
                      ...
                      <strong>understands the Crystal Beach area</strong>. We
                    ...
                    <p>
                      ...
                      people search for services in Crystal Beach. This means
                    ...
                    <p>
                      ...
                      become a trusted digital marketing company for Crystal
                      Beach businesses. If you're looking to grow your business
                      online, we're here to help!
                    </p>
                    <Image
                      className="img-fluid"
                      src={best}
                      alt="digital marketing company crystal beach"
                    />
                  </motion.div>
                </div>
                <div className="col-lg-6">
                  ...
                  >
                    <div className="card">
                      <img
                        alt="digital marketing agency crystal beach client review"
                        width="48"
                        height="48"
            ...
            <Container>
              <Row className="text-center">
                <Col lg="12">
                  ...
                  >
                    <h2>
                      Our <span>Digital Marketing Services</span> in Crystal
                      Beach
                    </h2>
                  </motion.div>
                </Col>
                ...
                <Row className="pd-top-40">
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image
                        src={img1}
                        alt="social media marketing crystal beach"
                      />
                      <h3>Social Media Ads Marketing</h3>
                      <p>
                        Our digital marketing agency Crystal Beach team offers
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image
                        src={img2}
                        alt="local seo marketing crystal beach"
                      />
                      <h3>Local SEO Marketing</h3>
                      <p>
                        Our local SEO marketing service is all about helping
                        your business show up when people in Crystal Beach
                        search for services like yours. Our digital marketing
                        agency Crystal Beach team makes sure your website is
                  ...
                  <Col lg="4" className="d-flex">
                    <div className="card">
                      <Image
                        src={img3}
                        alt="search engine marketing crystal beach"
                      />
                      ...
                      <p>
                        ...
                        Our digital marketing agency Crystal Beach team uses
                ...
                <Col lg="6">
                  ...
                  >
                    <h2 className="pd-btm-40">
                      ...
                      <span>Crystal Beach Digital Marketing Agency</span>
                    </h2>
                    <div className="card">
                      <img
                        alt="crystal beach digital marketing agency client testimonial"
                        width="48"
                        height="48"
                        src="https://lh3.googleusercontent.com/a/ACg8ocIKt9X9LSKomYMvAkQn_0673Xwg0EBOP-QigGk1AaAVHdVIvA=w48-h48-p-rp-mo-ba3-br100"
                      />
                ...
                <Col lg="6">
                  ...
                  >
                    <Image
                      className="img-fluid"
                      src={results}
                      alt="crystal beach digital marketing agency case study"
                    />
                  </motion.div>
                </Col>
              </Row>
                    ...
                    <Accordion open={open} toggle={toggle}>
                      ...
                      <AccordionItem>
                        <AccordionHeader targetId="2">
                          How can your Crystal Beach digital marketing services
                          help my Crystal Beach business?
                        </AccordionHeader>
                        <AccordionBody accordionId="2">
                          <h2>
                            How can your Crystal Beach digital marketing
                            services help my Crystal Beach business?
                          </h2>
                          <p>
          ...
          <Container>
            <Row>
              <Col lg="12">
                ...
                >
                  <h2>
                    Delivering Digital Marketing Services surrounding Crystal
                    Beach:
                  </h2>
            ...
            <Row className="text-center">
              <Col lg="12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2>Need Crystal Beach Digital Marketing Services?</h2>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
                  whileInView={{ opacity: 1, y: 0 }}
