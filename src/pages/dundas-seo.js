...
import website from "../img/dundas-seo.webp";
...
const SEO = () => {
  return (
    <>
      <Helmet>
        <title>Dundas SEO | Affordable Local Search Engine Optimization</title>
        <meta
          name="description"
          content="Unleash the potential of Dundas SEO to amplify your online visibility. Command search outcomes, draw in a surge of visitors. Kickstart your optimization journey right now!"
        />
        <link rel="canonical" href="https://infused.agency/Dundas-seo" />
      </Helmet>
      <Nav />
      <InnerHero
        title="Dundas SEO Company"
        description="Infused Agency is an award-winning SEO company in Dundas. We help businesses bring in more revenue through their websites."
        bgImage={bgImage}
      />
      <InnerContent>
        <section className="seo-page">
            ...
            <Row className="web pd-btm-80">
              <Col md="4">
                <Image
                  className="img-fluid"
                  src={website}
                  alt="Dundas seo company, Dundas seo agency, Dundas seo services"
                />
              </Col>
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Dundas SEO services</strong> that our <strong>Dundas SEO company</strong> provides are
                ...
                <ul>
                  ...
                  <li>Improves your Dundas brand's awareness.</li>
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Our Dundas SEO Clients <span>Get Results</span>
                  </h2>
                </Col>
              </Row>
              <Row>
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      highly recommend their company if you are thinking of needing their Dundas SEO services."
                    </p>
                    <ul>
                      <li>
                        <strong>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <h4>KD Flowers</h4>
                    <p>
                      "Infused Agency drastically improved my online presence. By using their SEO services, my Dundas
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      SEO for your Dundas business I do recommend Infused Agency for their services. JD keep up the
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Ready to grow your business with top Dundas SEO services?</h3>
            ...
            <Container>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    Infused Agency's SEO company in Dundas conducts specific keyword research that covers specifically
                ...
                <Col lg="4">
                  <h5>Link Building</h5>
                  <p>
                    Off of your website, our Dundas SEO exports utilize efforts to build links to your website, to help
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Dundas SEO services are conducted by a highly trained group of marketers, which includes content
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    ...
                    give your users a poor user experience. This is why our Dundas SEO agency looks for and fixes these
                ...
                <Col lg="4">
                  <h5>Local SEO</h5>
                  <p>
                    For a more local approach, our Dundas SEO specialists can leverage the power of local SEO. We help
                ...
                <Col lg="4">
                  <h5>Technical SEO</h5>
                  <p>
                    If you find out about some technical mishaps on your website, our Dundas SEO experts are here to
          ...
          <section className="call-out">
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>Have Our Dundas SEO Experts Help Today</h3>
                  <p>Click the button below to get your free quote.</p>
                  <a target="_blank" rel="noreferrer" href="https://calendly.com/infused-agency/project-discovery/">
                    <button>Get Free Quote</button>
                  </a>
          ...
          <section className="seo-why pd-top-80">
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Dundas</span> SEO Agency
                  </h2>
              ...
              <Row>
                <Col lg="6">
                  <p>
                    Since 2013 we've been able to help countless local Dundas businesses (and beyond!) with their{" "}
                  ...
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d92923.29036637484!2d-80.14313671464886!3d43.29640372904509!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882c848533d7711d%3A0x27cd751919882040!2sDundas%2C%20Hamilton%2C%20ON!5e0!3m2!1sen!2sca!4v1709126224078!5m2!1sen!2sca"
                    width="600"
                    height="450"
                    allowfullscreen=""
                    loading="lazy"
          ...
          <Container>
            <Row className="pd-top-80 pd-btm-60">
              <Col lg="12">
                ...
                <h3>Do I need SEO?</h3>
                <p>
                  Does your business depend on attracting new customers? Then absolutely you need a Dundas SEO company
                  to help you with SEO services. It's important that our Dundas SEO experts help your website rank where
                ...
                <h3>Our Dundas SEO company is ready to help.</h3>
                <p>
                  If you need our Dundas SEO company to help your company rise in Google with our expert SEO services,
