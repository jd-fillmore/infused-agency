...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert SEO services, including lead generation, search engine optimization, and online marketing in Dundas, ON.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Dundas SEO 🥇 Best SEO Company in Dundas, ON | Infused Agency</title>
        <meta
          name="description"
          ...
          <Container>
            <Row className="web pd-btm-80">
              ...
              <Col lg={{ size: 7, offset: 1 }}>
                <p>
                  The <strong>Dundas SEO services</strong> that our{" "}
                  <strong>Dundas SEO company</strong> provides are pretty
            ...
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Our Nearby Dundas SEO Clients <span>Get Results</span>
                  </h2>
                </Col>
              </Row>
              <Row>
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      By using their SEO services, my Dundas company went from
                ...
                <Col lg="4">
                  <div className="card">
                    ...
                    <p>
                      ...
                      on my new web site. If you ever need a SEO for your Dundas
            ...
            <Container>
              <Row>
                <Col lg="12 text-center">
                  <h3>
                    Ready to grow your business with top Dundas SEO services?
                  </h3>
            ...
            <Container>
              ...
              <Row>
                <Col lg="4">
                  ...
                  <p>
                    Infused Agency's SEO company in Dundas conducts specific
                ...
                <Col lg="4">
                  <h5>Link Building</h5>
                  <p>
                    Off of your website, our Dundas SEO exports utilize efforts
                ...
                <Col lg="4">
                  ...
                  <p>
                    Our Dundas SEO services are conducted by a highly trained
              ...
              <Row className="pd-btm-80">
                <Col lg="4">
                  ...
                  <p>
                    ...
                    user experience. This is why our Dundas SEO agency looks for
                ...
                <Col lg="4">
                  <h5>Local SEO</h5>
                  <p>
                    For a more local approach, our Dundas SEO specialists can
                ...
                <Col lg="4">
                  ...
                  <p>
                    ...
                    website, our Dundas SEO experts are here to help. We'll dive
          ...
          <section className="seo-why pd-top-80">
            <Container>
              <Row>
                <Col lg="12 text-center pd-btm-40">
                  <h2>
                    Why Choose Infused Agency As Your <span>Dundas</span> SEO
                    Agency
                  </h2>
              ...
              <Row>
                <Col lg="6">
                  <p>
                    Since 2013 we've been able to help countless local Dundas
            ...
            <Row className="pd-top-80 pd-btm-60">
              <Col lg="12">
                ...
                <p>
                  ...
                  absolutely you need a Dundas SEO company to help you with SEO
                  services. It's important that our Dundas SEO experts help your
                ...
                <p>
                  If you need our Dundas SEO company to help your company rise
