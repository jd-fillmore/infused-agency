...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert Port Colborne SEO services, including lead generation, development, and online marketing in Port Colborne, Canada.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Port Colborne SEO | Best SEO Agency in Port Colborne, ON</title>
        <meta
          name="description"
