...
const addJsonLd = () => {
  const schema = {
    ...
    name: "Infused Agency",
    description:
      "Infused Agency provides expert Markham SEO services, including lead generation, development, and online marketing in Markham, Canada.",
    serviceArea: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
...
const SEO = () => {
  return (
    <>
      <Head>
        <title>Markham SEO | Best SEO Services in Markham, ON</title>
        <meta
          name="description"
